...
System.register("./panel-entry-DmQDHJ40-D60KMmIp.js", ['./___monkey.entry.js','./dom-CKuHtFmo-DMnoa_ZO.js','./json-file-cB2aMqH3-PVWeN9jz.js','./noise-tags-DE4IEFIi-KlIgLGow.js','./format-date-XvZTiyRk-BqZod_Ay.js','./module-settings-BW4GnAGI-nqS69-Y6.js','./objectWithoutProperties-CjlH8YfO-CZ6HfuTg.js'],(function(exports){'use strict';var z$1,t,ht$1,b,ze$1,R$1,nt$1,d$1,st$1,ae$1,Ee$1,Se$1,e,n,i,a,o,e$1,a$1,s,t$1;return{setters:[function(module){z$1=module.z;t=module.t;ht$1=module.h;b=module.b;ze$1=module.a;R$1=module.R;nt$1=module.n;d$1=module.d;st$1=module.s;ae$1=module.c;Ee$1=module.E;Se$1=module.S;},function(module){e=module.e;},function(module){n=module.n;i=module.i;},function(module){a=module.a;o=module.o;},function(module){e$1=module.e;},function(module){a$1=module.a;s=module.s;},function(module){t$1=module.t;}],execute:(function(){exports("openAO3HPanel",ia);var x=`.ao3h-panel-box{--ao3h-accent:#900;--ao3h-accent-hover:#c00;--ao3h-accent-rgb:153, 0, 0;--ao3h-text-primary:#333;--ao3h-text-secondary:#555;--ao3h-text-muted:#666;--ao3h-text-faint:#767676;--ao3h-text-hint:#767676;--ao3h-border:#e8e8e8;--ao3h-border-medium:#e0e0e0;--ao3h-border-strong:#d0d0d0;--ao3h-border-input:#cfd6e4;--ao3h-bg-surface:#fafafa;--ao3h-bg-hover:#f9f9f9;--ao3h-bg-subtle:#f5f5f5;--ao3h-radius-sm:4px;--ao3h-radius-md:6px;--ao3h-radius-lg:8px;--ao3h-space-1:4px;--ao3h-space-2:8px;--ao3h-space-3:12px;--ao3h-space-4:16px;--ao3h-space-5:20px;--ao3h-space-6:24px;--ao3h-space-8:32px;--ao3h-size-xxs:.6875rem;--ao3h-size-xs:.75rem;--ao3h-size-sm:.8125rem;--ao3h-size-base:.9375rem;--ao3h-label-color:var(--ao3h-text-primary);--ao3h-label-size:.8125rem;--ao3h-label-weight:600;--ao3h-title-color:var(--ao3h-accent);--ao3h-title-size:.9375rem;--ao3h-description-color:var(--ao3h-text-faint);--ao3h-description-size:var(--ao3h-size-xs);--ao3h-control-color:var(--ao3h-text-secondary);--ao3h-control-size:var(--ao3h-label-size);--ao3h-control-gap:8px;--ao3h-checkbox-accent:var(--ao3h-accent)}.ao3h-panel-backdrop{z-index:999998;background:rgba(0,0,0,.35);position:fixed;top:0;bottom:0;left:0;right:0}.ao3h-panel-box{z-index:999999;background:#fff;border-radius:6px;flex-direction:column;width:800px;max-width:98vw;height:650px;max-height:95vh;padding:0;font-family:Lucida Grande,Lucida Sans Unicode,Verdana,Helvetica,sans-serif;display:flex;position:fixed;top:50%;left:50%;overflow:hidden;transform:translate(-50%,-50%);box-shadow:0 16px 40px rgba(2,15,35,.12)}.ao3h-panel-box *{box-sizing:border-box}.ao3h-panel-box :where(button){color:inherit;font-size:inherit;font-weight:inherit;height:auto;min-height:0;line-height:inherit;box-sizing:border-box;cursor:pointer;vertical-align:middle;background:0 0;border:none;border-radius:0;align-items:center;width:auto;padding:0;font-family:inherit;text-decoration:none;display:inline-flex}.ao3h-panel-body{background:#fff;flex-direction:column;flex:1;order:4;padding:0;display:flex;position:relative;overflow:hidden}#ao3h-tab-container{padding:var(--ao3h-space-5) var(--ao3h-space-6);scroll-behavior:smooth;flex:1;min-height:400px;transition:opacity .2s ease-out;overflow-y:auto}.ao3h-panel-header{padding:var(--ao3h-space-4) 28px;border-bottom:1px solid var(--ao3h-border);background:#900 url(https://archiveofourown.org/images/skins/textures/tiles/red-ao3.png);order:1;justify-content:space-between;align-items:center;display:flex;box-shadow:inset 0 -6px 10px rgba(0,0,0,.35),1px 1px 3px -1px rgba(0,0,0,.25),inset 0 -1px rgba(0,0,0,.85)}.ao3h-panel-title{color:rgba(255,255,255,.85);letter-spacing:-.3px;text-shadow:0 1px 2px rgba(0,0,0,.35);margin:0;font-family:Georgia,serif;font-size:1.125rem;font-weight:600}.ao3h-panel-close{color:rgba(255,255,255,.75);cursor:pointer;border-radius:var(--ao3h-radius-md);background:0 0;border:none;padding:4px 8px;font-size:1.1rem;line-height:1;transition:background .2s,color .2s}.ao3h-panel-tabs-container{background:var(--ao3h-bg-surface);border-bottom:2px solid var(--ao3h-border);padding:var(--ao3h-space-2);justify-content:center;gap:var(--ao3h-space-1);flex-wrap:wrap;order:3;display:flex}.ao3h-panel-tabs-row{justify-content:center;gap:6px;width:100%;margin-bottom:6px;display:flex}.ao3h-panel-tabs-row:last-child{margin-bottom:0}.ao3h-tab-btn{border-radius:var(--ao3h-radius-lg);color:var(--ao3h-text-muted);cursor:pointer;white-space:nowrap;text-align:center;background:0 0;border:none;border-bottom:3px solid transparent;border-radius:4px;flex:none;justify-content:center;align-items:center;min-width:-webkit-fit-content;min-width:-moz-fit-content;min-width:fit-content;min-height:34px;padding:6px 12px;font-size:.8125rem;font-weight:600;line-height:1.3;transition:background .2s,color .2s,border-color .2s,box-shadow .2s;display:flex}.ao3h-tab-btn:hover{color:var(--ao3h-text-primary);background:rgba(var(--ao3h-accent-rgb), .05);border-bottom-color:rgba(var(--ao3h-accent-rgb), .3)}.ao3h-tab-btn:focus-visible{box-shadow:0 0 0 2px rgba(var(--ao3h-accent-rgb), .3);outline:none}.ao3h-tab-btn.ao3h-tab-active{color:var(--ao3h-accent);box-shadow:none;background:0 0;border:none;border-bottom:3px solid #900;border-radius:0;font-weight:600}.ao3h-global-search-wrapper{border-bottom:1px solid var(--ao3h-border);align-items:center;gap:var(--ao3h-space-2);background:#fff;flex-shrink:0;order:2;padding:8px 20px;display:flex}.ao3h-global-search-wrapper .ao3h-global-search-input{flex:1}.ao3h-global-search-wrapper .ao3h-bulk-actions-buttons{flex-shrink:0;gap:6px;display:flex}.ao3h-global-search-input{box-sizing:border-box;border:1px solid var(--ao3h-border-strong);border-radius:var(--ao3h-radius-sm);width:100%;font-size:var(--ao3h-size-xs);padding:8px 14px;transition:border-color .2s}.ao3h-global-search-input:focus{border-color:var(--ao3h-accent);box-shadow:0 0 0 2px rgba(var(--ao3h-accent-rgb), .08);outline:none}.ao3h-search-no-results{color:var(--ao3h-text-hint);text-align:center;font-size:var(--ao3h-size-sm);padding:24px 20px}.ao3h-search-tab-badge{font-size:var(--ao3h-size-xxs);color:var(--ao3h-text-muted);white-space:nowrap;background:#f0f0f0;border:1px solid #ddd;border-radius:3px;flex-shrink:0;margin-right:4px;padding:2px 6px;display:inline-block}.ao3h-module-container{border-bottom:1px solid var(--ao3h-border);transition:background-color .3s}.ao3h-module-container:last-child{border-bottom:none}.ao3h-module-container:has(.ao3h-module-config-area.ao3h-expanded){padding-bottom:var(--ao3h-space-4)}.ao3h-module-container.ao3h-highlight{background-color:rgba(144,0,0,.08);animation:.5s ease-in-out ao3h-highlight-pulse}@keyframes ao3h-highlight-pulse{0%{background-color:rgba(144,0,0,.2)}to{background-color:rgba(144,0,0,.08)}}.ao3h-module-row{align-items:center;gap:var(--ao3h-space-4);border-radius:var(--ao3h-radius-sm);cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;border:2px solid transparent;margin:0 -8px;padding:8px 10px;transition:background .2s,border-color .2s;display:flex}.ao3h-module-row:hover{background:var(--ao3h-bg-hover);border-color:transparent}.ao3h-module-container:has(.ao3h-module-config-area.ao3h-expanded) .ao3h-module-row{background:var(--ao3h-bg-hover);border-color:#900;border-radius:4px 4px 0 0}.ao3h-module-quick-toggle{cursor:pointer;justify-content:center;align-items:center;margin:0;padding:0;display:flex;position:relative}.ao3h-module-quick-toggle:before{content:"";position:absolute;top:-8px;bottom:-8px;left:-12px;right:-12px}.ao3h-quick-enable-checkbox{cursor:pointer;accent-color:var(--ao3h-accent);width:16px!important;height:16px!important;margin:0!important}.ao3h-module-info{flex:1}.ao3h-module-name{font-size:var(--ao3h-size-base);color:var(--ao3h-text-primary);text-transform:none;letter-spacing:normal;margin-bottom:4px;font-family:Georgia,serif;font-weight:500}.ao3h-module-desc{color:var(--ao3h-description-color);padding-left:8px;font-size:.75rem;line-height:1.4}.ao3h-module-controls{gap:var(--ao3h-space-3);align-items:center;display:flex}.ao3h-config-btn{border-radius:var(--ao3h-radius-sm);padding:var(--ao3h-space-1) var(--ao3h-space-2);font-size:var(--ao3h-size-xxs);cursor:pointer;color:var(--ao3h-text-muted);vertical-align:baseline;text-align:center;box-sizing:border-box;background:0 0;border:none;flex-shrink:0;justify-content:center;align-items:center;min-width:24px;height:24px;line-height:1;transition:none;display:inline-flex}.ao3h-config-btn:hover{color:var(--ao3h-text-muted);background:0 0;border-color:transparent}.ao3h-module-config-area{interpolate-size:allow-keywords;background:var(--ao3h-bg-surface);border:2px solid var(--ao3h-border-medium);border-radius:0 0 var(--ao3h-radius-sm) var(--ao3h-radius-sm);opacity:0;height:0;font-size:var(--ao3h-size-sm);border-top:none;margin:0 -8px;padding:0 16px;transition:height .4s cubic-bezier(.4,0,.2,1),padding .4s cubic-bezier(.4,0,.2,1),opacity .4s cubic-bezier(.4,0,.2,1);overflow:clip}.ao3h-module-config-area.ao3h-expanded{height:auto;padding:var(--ao3h-space-4);padding-top:var(--ao3h-space-6);opacity:1;column-gap:var(--ao3h-space-6);row-gap:var(--ao3h-space-2);grid-template-columns:1fr 1fr;align-items:start;transition:height .4s cubic-bezier(.4,0,.2,1),padding .4s cubic-bezier(.4,0,.2,1),opacity .5s ease-out .1s;display:grid;overflow:visible}.ao3h-settings-row{flex-flow:row;align-items:flex-start;gap:16px 32px;display:flex}.ao3h-settings-row .ao3h-setting-item{flex:1}.ao3h-module-config-area.ao3h-expanded>.ao3h-settings-row{display:contents}.ao3h-config-section{grid-column:1/-1;grid-template-columns:subgrid;row-gap:var(--ao3h-space-2);align-items:start;margin-bottom:0;display:grid}.ao3h-config-section:last-child{margin-bottom:0}.ao3h-config-section+.ao3h-config-section{padding-top:2px}.ao3h-setting-group{grid-column:1/-1;grid-template-columns:subgrid;border:1px solid var(--ao3h-border);border-radius:var(--ao3h-radius-md);padding:var(--ao3h-space-3) var(--ao3h-space-4);align-items:start;row-gap:5px;margin-bottom:8px;display:grid;box-shadow:inset 0 2px 6px rgba(0,0,0,.15)}.ao3h-setting-group:last-child{margin-bottom:0}.ao3h-setting-group>.ao3h-setting-label{margin-bottom:8px}.ao3h-setting-group>.ao3h-setting-item{margin-bottom:0}:-webkit-any(.ao3h-module-config-area.ao3h-expanded,.ao3h-config-section,.ao3h-setting-group)>:-webkit-any(.ao3h-config-row,.ao3h-setting-description,.ao3h-setting-label,.ao3h-config-block,div[id]:not(.ao3h-setting-item)){grid-column:1/-1}:-moz-any(.ao3h-module-config-area.ao3h-expanded,.ao3h-config-section,.ao3h-setting-group)>:-moz-any(.ao3h-config-row,.ao3h-setting-description,.ao3h-setting-label,.ao3h-config-block,div[id]:not(.ao3h-setting-item)){grid-column:1/-1}:is(.ao3h-module-config-area.ao3h-expanded,.ao3h-config-section,.ao3h-setting-group)>:is(.ao3h-config-row,.ao3h-setting-description,.ao3h-setting-label,.ao3h-config-block,div[id]:not(.ao3h-setting-item)){grid-column:1/-1}:-webkit-any(.ao3h-module-config-area.ao3h-expanded,.ao3h-config-section)>:-webkit-any(.ao3h-config-section-title,.ao3h-config-footer){grid-column:1/-1}:-moz-any(.ao3h-module-config-area.ao3h-expanded,.ao3h-config-section)>:-moz-any(.ao3h-config-section-title,.ao3h-config-footer){grid-column:1/-1}:is(.ao3h-module-config-area.ao3h-expanded,.ao3h-config-section)>:is(.ao3h-config-section-title,.ao3h-config-footer){grid-column:1/-1}:-webkit-any(.ao3h-module-config-area.ao3h-expanded,.ao3h-config-section)>:-webkit-any(.ao3h-setting-item,.ao3h-setting-group,.ao3h-setting-label,.ao3h-setting-description){margin-bottom:0}:-moz-any(.ao3h-module-config-area.ao3h-expanded,.ao3h-config-section)>:-moz-any(.ao3h-setting-item,.ao3h-setting-group,.ao3h-setting-label,.ao3h-setting-description){margin-bottom:0}:is(.ao3h-module-config-area.ao3h-expanded,.ao3h-config-section)>:is(.ao3h-setting-item,.ao3h-setting-group,.ao3h-setting-label,.ao3h-setting-description){margin-bottom:0}.ao3h-config-section>div[id]:not(.ao3h-setting-item)>.ao3h-setting-item{margin-bottom:0}:where(.ao3h-module-config-area.ao3h-expanded>div[id]:not(.ao3h-setting-item),.ao3h-config-section>div[id]:not(.ao3h-setting-item)):has(>.ao3h-setting-item){column-gap:var(--ao3h-space-6);row-gap:var(--ao3h-space-2);grid-template-columns:1fr 1fr;align-items:start;display:grid}:-webkit-any(.ao3h-module-config-area.ao3h-expanded,.ao3h-config-section,.ao3h-setting-group)>.ao3h-setting-item:has(.ao3h-setting-control--radios-stacked,.ao3h-setting-control--checkboxes,.ao3h-radio-group,input:not([type=checkbox]):not([type=radio]),select,.ao3h-setting-note){grid-column:1/-1}:-moz-any(.ao3h-module-config-area.ao3h-expanded,.ao3h-config-section,.ao3h-setting-group)>.ao3h-setting-item:has(.ao3h-setting-control--radios-stacked,.ao3h-setting-control--checkboxes,.ao3h-radio-group,input:not([type=checkbox]):not([type=radio]),select,.ao3h-setting-note){grid-column:1/-1}:is(.ao3h-module-config-area.ao3h-expanded,.ao3h-config-section,.ao3h-setting-group)>.ao3h-setting-item:has(.ao3h-setting-control--radios-stacked,.ao3h-setting-control--checkboxes,.ao3h-radio-group,input:not([type=checkbox]):not([type=radio]),select,.ao3h-setting-note){grid-column:1/-1}.ao3h-col1{grid-column:1!important}.ao3h-col2{grid-column:2!important}.ao3h-full{grid-column:1/-1!important}.ao3h-module-config-area label,.ao3h-module-config-area p{font-size:var(--ao3h-label-size)}.ao3h-setting-item{margin-bottom:14px}.ao3h-setting-item:last-child{margin-bottom:0}.ao3h-setting-description{font-size:var(--ao3h-description-size);color:var(--ao3h-description-color);margin-top:2px;margin-bottom:8px;line-height:1.5}.ao3h-setting-item:has(+.ao3h-setting-description){margin-bottom:2px}.ao3h-module-config-area.ao3h-expanded>.ao3h-setting-item+.ao3h-setting-description,.ao3h-config-section>.ao3h-setting-item+.ao3h-setting-description{margin-top:-4px}.ao3h-setting-label{font-size:var(--ao3h-label-size);font-weight:var(--ao3h-label-weight);color:var(--ao3h-label-color);margin-bottom:8px;display:block}.ao3h-setting-item>.ao3h-setting-label{margin-top:var(--ao3h-space-4);margin-bottom:var(--ao3h-space-4)}.ao3h-config-section>.ao3h-config-section-title+.ao3h-setting-item>.ao3h-setting-label{margin-top:0}.ao3h-module-config-area.ao3h-expanded>.ao3h-setting-item~.ao3h-setting-label,.ao3h-config-section>.ao3h-setting-item~.ao3h-setting-label,.ao3h-module-config-area.ao3h-expanded>.ao3h-setting-description~.ao3h-setting-label,.ao3h-config-section>.ao3h-setting-description~.ao3h-setting-label{margin-top:var(--ao3h-space-2)}.ao3h-setting-note{font-size:var(--ao3h-size-xxs);color:var(--ao3h-text-hint);margin-left:4px;font-weight:400}.ao3h-setting-control{align-items:center;gap:var(--ao3h-control-gap);font-size:var(--ao3h-control-size);color:var(--ao3h-control-color);margin-bottom:6px;display:flex}.ao3h-setting-control:last-child{margin-bottom:0}.ao3h-setting-control label{cursor:pointer;align-items:center;gap:8px;line-height:1;display:inline-flex}.ao3h-panel-box input[type=checkbox]{vertical-align:unset;accent-color:var(--ao3h-accent);flex-shrink:0;align-self:center;transform:translateY(-1px);width:14px!important;height:14px!important;box-shadow:none!important;-webkit-appearance:auto!important;-moz-appearance:auto!important;-ms-appearance:auto!important;appearance:auto!important;border:none!important;margin:0!important}.ao3h-panel-box input[type=radio]{vertical-align:unset;accent-color:var(--ao3h-accent);flex-shrink:0;align-self:center;transform:translateY(-1px);width:14px!important;height:14px!important;box-shadow:none!important;-webkit-appearance:auto!important;-moz-appearance:auto!important;-ms-appearance:auto!important;appearance:auto!important;border:none!important;margin:0!important}.ao3h-panel-box label:has(input[type=checkbox]){align-items:center;gap:8px;line-height:1;display:inline-flex}.ao3h-panel-box label:has(input[type=radio]){align-items:center;gap:8px;line-height:1;display:inline-flex}.ao3h-setting-control.ao3h-setting-control--checkboxes{flex-flow:wrap;align-items:center;gap:6px 16px;margin-bottom:0}.ao3h-setting-control.ao3h-setting-control--checkboxes-stacked,.ao3h-setting-control.ao3h-setting-control--radios-stacked{flex-direction:column;align-items:flex-start;gap:10px;margin-bottom:0}.ao3h-setting-control.ao3h-setting-control--radios,.ao3h-setting-control.ao3h-radio-group{flex-wrap:wrap;align-items:center;gap:6px 16px;margin-bottom:0}.ao3h-setting-control.ao3h-radios-cols{grid-template-columns:1fr 1fr;align-items:start;gap:6px 16px;display:grid}.ao3h-color-swatch-group{gap:var(--ao3h-space-2);flex-wrap:wrap;align-items:center;display:flex}.ao3h-color-swatch-label{cursor:pointer;display:flex;position:relative}.ao3h-color-swatch-label input[type=radio]{opacity:0;pointer-events:none;width:1px;height:1px;position:absolute}.ao3h-color-swatch{box-sizing:border-box;border:2px solid transparent;border-radius:50%;width:22px;height:22px;transition:transform .1s,border-color .1s;display:inline-block}.ao3h-color-swatch-label:hover .ao3h-color-swatch{border-color:var(--ao3h-text-faint);transform:scale(1.15)}.ao3h-color-swatch-label input[type=radio]:checked~.ao3h-color-swatch{border-color:var(--ao3h-text-primary);box-shadow:0 0 0 2px #fff, 0 0 0 4px var(--ao3h-text-primary)}.ao3h-setting-checkbox{cursor:pointer;accent-color:var(--ao3h-checkbox-accent);width:16px!important;height:16px!important}.ao3h-quick-access>a{font-weight:600;color:#2c5f8a!important}.ao3h-settings-section{padding-bottom:var(--ao3h-space-4);margin-bottom:var(--ao3h-space-4);border-bottom:1px solid var(--ao3h-border)}.ao3h-settings-section:last-child{border-bottom:none;margin-bottom:0;padding-bottom:0}.ao3h-setting-hint{font-size:var(--ao3h-size-xxs);color:var(--ao3h-text-faint);margin-top:4px;line-height:1.4}.ao3h-config-section>.ao3h-section-actions{order:99;grid-column:1/-1;justify-content:flex-start;margin-top:10px}.ao3h-config-section>.ao3h-config-row:has([data-action*=export],[data-action*=import]){order:99;grid-column:1/-1;justify-content:flex-start;margin-top:10px}.ao3h-config-section>.ao3h-config-section-title+.ao3h-config-row:has([data-action*=export],[data-action*=import]){margin-top:0}.ao3h-config-section>.ao3h-section-actions:has([data-action^=clear]){justify-content:flex-start}.ao3h-config-section>.ao3h-config-row:has([data-action*=export],[data-action*=import]):has([data-action^=clear]){justify-content:flex-start}.ao3h-module-config-area .ao3h-section-actions{margin-top:10px}[data-action^=clear]{margin-left:auto}.ao3h-config-section>.ao3h-config-row:has([data-action^=clear]):not(:has([data-action*=import],[data-action*=export])){order:99;grid-column:1/-1;justify-content:flex-end;margin-top:10px}.ao3h-config-section-title{font-size:var(--ao3h-title-size);color:var(--ao3h-title-color);padding:var(--ao3h-space-5) 0 4px 0;margin:var(--ao3h-space-4) 0 var(--ao3h-space-4);border-top:1px solid var(--ao3h-border-strong);align-items:baseline;font-family:Georgia,serif;font-weight:400;display:flex}.ao3h-config-section:first-child>.ao3h-config-section-title{border-top:none;margin-top:0;padding-top:4px}.ao3h-section-count{font-weight:400;font-size:var(--ao3h-size-xs);color:#bbb;margin-left:auto}.ao3h-section-actions{gap:var(--ao3h-space-1);justify-content:flex-start;align-items:start;display:flex}.ao3h-section-actions:has([data-action^=clear]){justify-content:flex-start}.ao3h-section-title-clear{font-size:var(--ao3h-size-xxs);opacity:.7;margin-bottom:2px;padding:2px 8px;transition:opacity .15s}.ao3h-section-title-clear:hover{opacity:1}.ao3h-section-disabled{opacity:.38;pointer-events:none;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;-webkit-filter:grayscale(.25);filter:grayscale(.25)}.ao3h-config-input{font-size:var(--ao3h-size-xs);border:1px solid var(--ao3h-border-input);border-radius:var(--ao3h-radius-sm);box-sizing:border-box;background:#fff;padding:6px 10px;box-shadow:inset 0 1px 2px #ccc}.ao3h-setting-select{font-size:var(--ao3h-size-sm);padding:var(--ao3h-space-1) var(--ao3h-space-2);border:1px solid var(--ao3h-border-input);border-radius:var(--ao3h-radius-sm);background:#fff}.ao3h-select{border:1px solid var(--ao3h-border-strong);border-radius:var(--ao3h-radius-sm);font-size:var(--ao3h-size-xs);color:var(--ao3h-text-primary);cursor:pointer;background:#fff;min-width:140px;padding:6px 10px}.ao3h-select:focus{border-color:var(--ao3h-accent);outline:none}.ao3h-input{border:1px solid var(--ao3h-border-strong);border-radius:var(--ao3h-radius-sm);font-size:var(--ao3h-size-xs);color:var(--ao3h-text-primary);background:#fff;padding:6px 10px}.ao3h-input:focus{border-color:var(--ao3h-accent);outline:none}.ao3h-inline-btn{color:#444;height:28px;box-shadow:none;font-size:var(--ao3h-size-xs);cursor:pointer;white-space:nowrap;background:linear-gradient(#fff 2%,#ddd 95%,#bbb 100%);border:1px solid #bbb;border-bottom-color:#aaa;border-radius:3px;flex-shrink:0;padding:0 10px}.ao3h-inline-btn:not(.ao3h-inline-btn--danger):hover{border-top-color:#999;border-left-color:#999;box-shadow:inset 2px 2px 2px #bbb}.ao3h-inline-btn--green{color:#2e7d32;background:linear-gradient(#f1f8e9 2%,#c8e6c9 95%,#a5d6a7 100%);padding:0 12px;font-weight:400}.ao3h-inline-btn--purple{color:var(--ao3h-text-primary);padding:0 12px;font-weight:400}.ao3h-inline-btn--danger{color:#c62828;background:#fff5f5;border-color:#e57373}.ao3h-group-select{position:relative}.ao3h-group-select__trigger{text-align:left;cursor:pointer;white-space:nowrap;text-overflow:ellipsis;color:#757575;width:100%;height:28px;padding-right:28px;position:relative;overflow:hidden}.ao3h-group-select__trigger:after{content:"▾";color:#666;pointer-events:none;font-size:13px;position:absolute;top:50%;right:10px;transform:translateY(-50%)}.ao3h-group-select__trigger--active{color:var(--ao3h-text-primary);font-weight:600}.ao3h-group-select__panel{border-radius:var(--ao3h-radius-sm);z-index:9999;background:#fff;border:1px solid #ccc;max-height:200px;position:absolute;top:calc(100% + 3px);left:0;right:0;overflow-y:auto;box-shadow:0 4px 10px rgba(0,0,0,.12)}.ao3h-group-select__option{cursor:pointer;font-size:var(--ao3h-size-xs);text-align:center;border-bottom:1px solid var(--ao3h-border);padding:6px 10px}.ao3h-group-select__option:last-child{border-bottom:none}.ao3h-group-select__option:hover{background:var(--ao3h-bg-subtle)}.ao3h-group-select__option--selected{color:var(--ao3h-text-primary);font-weight:700}.ao3h-group-select__option--new{color:#2d4f78;background:#edf2f9;border-top:2px solid #c2d4e8;border-bottom:none;font-weight:600}.ao3h-group-select__option--new:hover{background:#dde8f5}.ao3h-config-row{margin-top:var(--ao3h-space-2);flex-wrap:wrap;align-items:center;gap:6px;padding-top:8px;display:flex}.ao3h-config-row:first-child,.ao3h-config-block>.ao3h-config-row{margin-top:0;padding-top:0}.ao3h-config-row:last-child{margin-bottom:0}:-webkit-any(.ao3h-module-config-area.ao3h-expanded,.ao3h-config-section,.ao3h-setting-group)>.ao3h-config-row{margin-top:0;margin-bottom:0;padding-top:0}:-moz-any(.ao3h-module-config-area.ao3h-expanded,.ao3h-config-section,.ao3h-setting-group)>.ao3h-config-row{margin-top:0;margin-bottom:0;padding-top:0}:is(.ao3h-module-config-area.ao3h-expanded,.ao3h-config-section,.ao3h-setting-group)>.ao3h-config-row{margin-top:0;margin-bottom:0;padding-top:0}.ao3h-config-row>label{cursor:pointer;align-items:center;gap:5px;display:inline-flex}.ao3h-config-row--end{justify-content:flex-end;gap:var(--ao3h-space-1)}.ao3h-config-row--tight{margin-bottom:4px;padding-top:0}.ao3h-config-row:has(+.ao3h-config-row--tight){margin-bottom:2px}.ao3h-config-row--wide{gap:var(--ao3h-space-4)}.ao3h-label--bold{font-weight:600}.ao3h-label--secondary{font-size:var(--ao3h-size-xs);color:var(--ao3h-text-muted)}.ao3h-indent{padding-left:32px}.ao3h-config-row.ao3h-config-row--child{margin-top:0;padding-top:8px;padding-left:32px}.ao3h-config-section-title+.ao3h-config-row{margin-bottom:8px}.ao3h-config-block+.ao3h-config-row--end{margin-top:var(--ao3h-space-4)}.ao3h-setting-item+.ao3h-indent,.ao3h-config-block+.ao3h-indent{margin-top:-6px}.ao3h-setting-description+.ao3h-config-row{margin-top:6px}.ao3h-config-row+.ao3h-config-block{margin-top:12px}:has(>.ao3h-config-row:last-child)+.ao3h-config-block{margin-top:12px}.ao3h-config-section>div[id]:not(.ao3h-setting-item):not(:first-child),.ao3h-module-config-area.ao3h-expanded>div[id]:not(.ao3h-setting-item):not(:first-child){padding-top:10px}.ao3h-setting-item+.ao3h-config-row,.ao3h-setting-control+.ao3h-config-row{margin-top:var(--ao3h-space-2)}.ao3h-config-separator{background:var(--ao3h-border-medium);flex-shrink:0;width:1px;height:16px}.ao3h-config-divider{border:none;border-top:1px solid var(--ao3h-border);grid-column:1/-1}.ao3h-setting-description:last-child,.ao3h-config-block>.ao3h-setting-item:last-child{margin-bottom:0}.ao3h-config-chipbox{min-height:38px;padding:var(--ao3h-space-2);border:1px solid var(--ao3h-border-input);border-radius:var(--ao3h-radius-lg);background:#fff;flex-wrap:wrap;align-items:center;gap:5px;margin-bottom:8px;display:flex}.ao3h-checkbox-group{gap:var(--ao3h-space-3);flex-wrap:wrap}.ao3h-checkbox-label{font-size:var(--ao3h-size-xs);color:var(--ao3h-text-secondary);cursor:pointer;align-items:center;gap:6px;display:inline-flex}.ao3h-checkbox-label input[type=checkbox]{cursor:pointer}.ao3h-radio-label{font-size:var(--ao3h-size-xs);color:var(--ao3h-text-secondary);cursor:pointer;align-items:flex-start;gap:6px;line-height:1.4;display:flex}.ao3h-radio-label input[type=radio]{margin-top:2px}.ao3h-btn{border-radius:var(--ao3h-radius-sm);font-size:var(--ao3h-size-xs);cursor:pointer;white-space:nowrap;justify-content:center;align-items:center;height:28px;padding:6px 12px;font-weight:500;line-height:1;transition:all .2s;display:inline-flex}.ao3h-btn-primary{background:var(--ao3h-accent);color:#fff;border:none}.ao3h-btn-primary:hover{background:var(--ao3h-accent-hover)}.ao3h-btn-secondary{color:var(--ao3h-text-muted);border:1px solid var(--ao3h-border-strong);background:0 0}.ao3h-btn-secondary:hover{background:var(--ao3h-bg-subtle);color:var(--ao3h-text-primary);border-color:#bbb}.ao3h-config-footer{border-top:1px solid var(--ao3h-border-medium);justify-content:flex-end;align-items:center;gap:var(--ao3h-space-2);margin-top:6px;padding-top:8px;display:flex}.ao3h-config-save-btn{color:#900;font-size:var(--ao3h-size-xs);cursor:pointer;box-shadow:none;white-space:nowrap;box-sizing:border-box;background:linear-gradient(#fff 2%,#ddd 95%,#bbb 100%);border:1px solid #bbb;border-bottom-color:#aaa;border-radius:.25em;justify-content:center;align-items:center;height:28px;padding:6px 12px;font-weight:600;line-height:1;display:inline-flex}.ao3h-config-save-btn:hover{color:#900;border-top-color:#999;border-left-color:#999;box-shadow:inset 2px 2px 2px #bbb}.ao3h-config-reset-btn{color:#444;font-size:var(--ao3h-size-xs);cursor:pointer;box-shadow:none;white-space:nowrap;box-sizing:border-box;background:linear-gradient(#fff 2%,#ddd 95%,#bbb 100%);border:1px solid #bbb;border-bottom-color:#aaa;border-radius:.25em;justify-content:center;align-items:center;height:28px;margin-right:auto;padding:6px 12px;font-weight:400;line-height:1;display:inline-flex}.ao3h-config-reset-btn:hover{color:#900;border-top-color:#999;border-left-color:#999;box-shadow:inset 2px 2px 2px #bbb}.ao3h-config-reset-btn.ao3h-reset-confirming{color:#7d5a00;background:#fff3cd;border-color:#e6a817;font-weight:600;animation:.4s ao3h-reset-pulse}.ao3h-config-reset-btn.ao3h-reset-confirming:hover{color:#5a3e00;background:#ffe69c;border-color:#c87800}@keyframes ao3h-reset-pulse{0%{transform:scale(1)}40%{transform:scale(1.06)}to{transform:scale(1)}}.ao3h-panel-box .ao3h-bulk-actions{z-index:100;background:var(--ao3h-bg-surface);border-top:1px solid var(--ao3h-border);padding:var(--ao3h-space-2) var(--ao3h-space-6);gap:var(--ao3h-space-3);font-size:var(--ao3h-size-xs);border-radius:0;flex-shrink:0;order:5;justify-content:flex-end;align-items:center;margin:0;display:flex;position:relative;bottom:auto;left:0;right:0}.ao3h-bulk-actions .note-box strong{color:var(--ao3h-text-primary)!important}.ao3h-bulk-actions-buttons{align-items:center;gap:6px;display:none}.ao3h-panel-box .ao3h-panel-action-btn{font-size:var(--ao3h-size-xs);color:#444;box-shadow:none;cursor:pointer;white-space:nowrap;box-sizing:border-box;background:linear-gradient(#fff 2%,#ddd 95%,#bbb 100%);border:1px solid #bbb;border-bottom-color:#aaa;border-radius:.25em;justify-content:center;align-items:center;height:28px;padding:6px 12px;font-weight:400;line-height:1;display:inline-flex}.ao3h-panel-box .ao3h-panel-action-btn:hover{color:#900;border-top-color:#999;border-left-color:#999;box-shadow:inset 2px 2px 2px #bbb}#ao3h-tab-container>.note-box{display:none!important}.ao3h-tab-count{text-align:right;font-size:var(--ao3h-size-xxs);color:var(--ao3h-text-hint);margin-top:-10px;margin-bottom:8px;padding:0 4px;font-weight:400}.ao3h-bulk-actions .note-box{font-size:var(--ao3h-size-xs)!important;color:var(--ao3h-text-muted)!important;background:0 0!important;border:none!important;border-radius:0!important;flex:1!important;margin:0 16px 0 0!important;padding:6px 10px!important;font-weight:500!important;display:block!important}.ao3h-footer-status{white-space:nowrap;text-overflow:ellipsis;overflow:hidden}.ao3h-footer-unsaved{color:#900;font-weight:600}.ao3h-picker-row{gap:var(--ao3h-space-2);align-items:center;display:flex}.ao3h-picker-row .ao3h-select{flex:1}.ao3h-picker-row .ao3h-btn{flex-shrink:0}.ao3h-chip-container{margin-top:var(--ao3h-space-2);border-radius:var(--ao3h-radius-sm);background:0 0;border:none;flex-wrap:wrap;align-items:center;gap:6px;min-height:28px;padding:6px;display:flex}.ao3h-picker-row+.ao3h-chip-container{margin-top:0;margin-left:4px}.ao3h-chip-container:empty:before{content:attr(data-empty-text);color:var(--ao3h-text-hint);font-style:italic;font-size:var(--ao3h-size-xxs)}.ao3h-chip-container:empty:not([data-empty-text]):before{content:"No items selected"}.ao3h-chip{background:var(--ao3h-accent);color:#fff;font-size:var(--ao3h-size-xxs);border-radius:12px;align-items:center;gap:2px;padding:2px 4px 2px 8px;display:inline-flex}.ao3h-chip button{color:rgba(255,255,255,.7);cursor:pointer;font-size:var(--ao3h-size-xs);background:0 0;border:none;border-radius:50%;justify-content:center;align-items:center;width:14px;height:14px;padding:0;line-height:1;display:flex}.ao3h-chip button:hover{color:#fff;background:rgba(255,255,255,.2)}.ao3h-chip--neutral{color:var(--ao3h-text-secondary);border:1px solid var(--ao3h-border-medium);background:#f0f0f0}.ao3h-chip--neutral button{color:#aaa}.ao3h-chip--neutral button:hover{color:var(--ao3h-text-primary);background:rgba(0,0,0,.08)}.ao3h-tag-chips{flex-wrap:wrap;gap:10px;display:flex}.ao3h-tag-chips-card{background:#fff;border:1px solid #e6e8ee;border-radius:10px;padding:10px 12px}.ao3h-tag-chips-card--empty{display:none}.ao3h-tag-chip{font-size:var(--ao3h-size-xxs);white-space:nowrap;background:#fff;border:1px solid #e6e8ee;border-radius:10px;align-items:center;gap:3px;max-width:160px;padding:4px 8px 4px 12px;transition:border-color .12s,background .12s;display:inline-flex}.ao3h-tag-chip>.ao3h-tag-chip-text{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.ao3h-tag-chip button{cursor:pointer;font-size:var(--ao3h-size-xs);border-radius:var(--ao3h-radius-sm);opacity:0;width:0;height:16px;color:var(--ao3h-text-faint);background:0 0;border:none;flex-shrink:0;justify-content:center;align-items:center;padding:0;line-height:1;transition:width .15s,opacity .12s;display:flex;overflow:hidden}.ao3h-tag-chip:hover button{opacity:1;width:16px}.ao3h-tag-chip button:hover{color:var(--ao3h-text-primary);background:rgba(0,0,0,.08)}.ao3h-tag-chip button.ao3h-tag-chip-remove{color:#900;opacity:.45;background:0 0;border:none;border-radius:3px;width:16px}.ao3h-tag-chip button.ao3h-tag-chip-remove:hover{opacity:1;background:0 0}.ao3h-module-list{gap:var(--ao3h-space-1);margin-top:var(--ao3h-space-2);scrollbar-width:thin;scrollbar-color:#ddd transparent;flex-direction:column;max-height:215px;display:flex;overflow-y:auto}.ao3h-module-list::-webkit-scrollbar{width:4px}.ao3h-module-list::-webkit-scrollbar-track{background:0 0}.ao3h-module-list::-webkit-scrollbar-thumb{background:#ddd;border-radius:1px}.ao3h-module-list::-webkit-scrollbar-thumb:hover{background:#bbb}.ao3h-module-list-entry{align-items:center;gap:var(--ao3h-space-2);border:1px solid var(--ao3h-border);font-size:var(--ao3h-size-xs);background:#fff;border-radius:5px;padding:6px 8px;display:flex;position:relative}.ao3h-module-list-entry:hover{border-color:var(--ao3h-border-strong);background:var(--ao3h-bg-surface)}.ao3h-module-list-entry-title{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.ao3h-module-list-entry-title a{color:var(--ao3h-accent);font-weight:500;font-size:var(--ao3h-size-sm);text-decoration:none}.ao3h-module-list-entry-title a:hover{text-decoration:underline}.ao3h-module-list-entry-meta{color:var(--ao3h-text-hint);font-size:var(--ao3h-size-xs);margin-left:4px}.ao3h-module-list-entry-badge{color:var(--ao3h-text-secondary);font-size:var(--ao3h-size-xs);white-space:nowrap;text-overflow:ellipsis;background:#f0f0f0;border-radius:10px;flex-shrink:1;max-width:180px;padding:4px 10px;transition:max-width .2s,white-space .1s;overflow:hidden}.ao3h-module-list-entry-actions{gap:var(--ao3h-space-1);flex-shrink:0;display:flex}.ao3h-module-list-footer{justify-content:space-between;align-items:flex-start;margin-top:-2px;display:flex}.ao3h-module-list-count{font-size:var(--ao3h-size-xs);color:var(--ao3h-text-hint);margin-top:-6px}.ao3h-setting-label--small{font-size:var(--ao3h-size-xs)}.ao3h-setting-label--large{font-size:var(--ao3h-size-sm)}.ao3h-setting-label--normal{font-weight:400}.ao3h-setting-label--muted{color:var(--ao3h-text-hint);font-weight:400}.ao3h-config-section-title--accent{color:var(--ao3h-accent)}.ao3h-config-section-title--no-border{border-top:none}.ao3h-config-section-title--compact{padding-bottom:1px}.ao3h-setting-item--indent{border-left:2px solid var(--ao3h-border);margin-left:2px;padding-left:14px}.ao3h-setting-item--compact{margin-bottom:4px}.ao3h-setting-description--warning{color:#7d5a00;padding:var(--ao3h-space-1) var(--ao3h-space-2);background:#fff8e1;border-left:3px solid #f5a623;border-radius:0 4px 4px 0;margin-top:4px}.ao3h-setting-description--info{color:#1565c0;padding:var(--ao3h-space-1) var(--ao3h-space-2);background:#e3f2fd;border-left:3px solid #2196f3;border-radius:0 4px 4px 0;margin-top:4px}.ao3h-setting-description--success{color:#2e7d32;padding:var(--ao3h-space-1) var(--ao3h-space-2);background:#e8f5e9;border-left:3px solid #4caf50;border-radius:0 4px 4px 0;margin-top:4px}.ao3h-setting-description--danger{color:#c62828;padding:var(--ao3h-space-1) var(--ao3h-space-2);background:#fff5f5;border-left:3px solid #e57373;border-radius:0 4px 4px 0;margin-top:4px}.ao3h-setting-control--column{flex-direction:column;align-items:flex-start;gap:6px}.ao3h-setting-checkbox--large{width:18px!important;height:18px!important}.ao3h-help-btn{border:1px solid var(--ao3h-border-strong);background:var(--ao3h-bg-subtle);color:#aaa;cursor:pointer;vertical-align:text-top;border-radius:50%;flex-shrink:0;justify-content:center;align-items:center;width:14px;height:14px;margin-left:5px;padding:0;font-size:.5625rem;font-weight:700;line-height:1;transition:background .15s,border-color .15s,color .15s;display:inline-flex;position:relative;top:-2px}.ao3h-help-btn:hover{border-color:var(--ao3h-accent);color:var(--ao3h-accent);background:#fff0f0}.ao3h-help-tooltip{z-index:1000001;border:1px solid var(--ao3h-border-medium);border-radius:var(--ao3h-radius-md);max-width:220px;font-size:var(--ao3h-size-xxs);color:var(--ao3h-text-secondary);background:#fff;padding:8px 10px;line-height:1.5;transition:opacity .4s;position:fixed;box-shadow:0 4px 16px rgba(0,0,0,.12)}.ao3h-help-tooltip--closing{opacity:0}.ao3h-setting-item[data-help-wired] .ao3h-setting-description,.ao3h-setting-label[data-help-wired]+.ao3h-setting-description{display:none}.ao3h-setting-item[data-help-wired]:has(+.ao3h-setting-description){margin-bottom:unset}.ao3h-panel-box{font-family:Lucida Grande,Lucida Sans Unicode,Verdana,Helvetica,sans-serif}.ao3h-panel-header{background:#900 url(https://archiveofourown.org/images/skins/textures/tiles/red-ao3.png);box-shadow:inset 0 -6px 10px rgba(0,0,0,.35),1px 1px 3px -1px rgba(0,0,0,.25),inset 0 -1px rgba(0,0,0,.85)}.ao3h-panel-title{color:rgba(255,255,255,.85);text-shadow:0 1px 2px rgba(0,0,0,.35);font-family:Georgia,serif;font-weight:600}.ao3h-panel-close{color:rgba(255,255,255,.75);background:0 0;padding:4px 8px;font-size:1.1rem}.ao3h-panel-close:hover{color:#fff;background:0 0}.ao3h-panel-tabs-row{gap:6px;margin-bottom:6px}.ao3h-tab-btn{border-radius:4px;font-size:.8125rem}.ao3h-tab-btn.ao3h-tab-active{color:#900;box-shadow:none;background:0 0;border:none;border-bottom:3px solid #900;border-radius:0}.ao3h-global-search-wrapper{background:#fff;padding:8px 20px}.ao3h-bulk-actions-buttons{display:none!important}.ao3h-module-row{padding:8px 10px}.ao3h-module-row:hover{border-color:transparent}.ao3h-module-row:hover .ao3h-module-name{color:#900}.ao3h-module-name{margin-bottom:8px;font-family:Georgia,serif;font-weight:500}.ao3h-module-desc{color:#767676;padding-left:8px;font-size:.75rem}.ao3h-tag-chip{color:#555;background:#fff;border:1px solid #e6e8ee;border-radius:10px}.ao3h-tag-chip:hover{background:#fff5f5;border-color:#900}.ao3h-panel-box input[type=checkbox]{accent-color:#900}.ao3h-panel-box input[type=radio]{accent-color:#900}.ao3h-setting-group{box-shadow:inset 0 2px 6px rgba(0,0,0,.15)}.ao3h-config-input,.ao3h-inline-btn{border-radius:3px}.ao3h-inline-btn:not(.ao3h-inline-btn--red):not(.ao3h-inline-btn--danger){color:#444;box-shadow:none;background-image:linear-gradient(#fff 2%,#ddd 95%,#bbb 100%);border:1px solid #bbb;border-bottom-color:#aaa}.ao3h-inline-btn.ao3h-inline-btn--green{color:#2e7d32;background-image:linear-gradient(#f1f8e9 2%,#c8e6c9 95%,#a5d6a7 100%)}.ao3h-config-action-btn{font-weight:400}.ao3h-inline-btn:not(.ao3h-inline-btn--red):not(.ao3h-inline-btn--danger):hover{border-top-color:#999;border-left-color:#999;box-shadow:inset 2px 2px 2px #bbb}.ao3h-footer-close,.ao3h-config-save-btn,.ao3h-config-reset-btn{color:#444;box-shadow:none;background:#eee linear-gradient(#fff 2%,#ddd 95%,#bbb 100%);border:1px solid #bbb;border-bottom-color:#aaa;border-radius:.25em}.ao3h-config-save-btn{color:#900;font-weight:600}.ao3h-footer-close:hover,.ao3h-config-save-btn:hover,.ao3h-config-reset-btn:hover{color:#900;border-top-color:#999;border-left-color:#999;box-shadow:inset 2px 2px 2px #bbb}.ao3h-footer-close:hover{color:#900}@media (max-width:700px){.ao3h-module-config-area.ao3h-expanded{grid-template-columns:1fr;column-gap:0}:where(.ao3h-module-config-area.ao3h-expanded>div[id]:not(.ao3h-setting-item),.ao3h-config-section>div[id]:not(.ao3h-setting-item)):has(>.ao3h-setting-item){grid-template-columns:1fr}.ao3h-setting-control.ao3h-radios-cols{grid-template-columns:1fr}}`,ee=`ao3h`,te=`WelcomeGuide`,S=`${ee}-welcome-seen`;ze$1(te,{title:`Welcome Guide`,enabledByDefault:true},function(){var t$1=t(function*(){if(localStorage.getItem(S))return ()=>{};let e=document.createElement(`div`);return e.style.cssText=`
  ...
  `,e.querySelector(`button`).addEventListener(`click`,()=>{localStorage.setItem(S,`true`),e.remove();}),document.body.appendChild(e),()=>{e.remove();}});function n(){return t$1.apply(this,arguments)}return n}());var C=`ao3h`;function w(){let e=document.createElement(`div`);e.className=`${C}-panel-backdrop`;let t=document.createElement(`div`);t.className=`${C}-panel-box`,t.setAttribute(`role`,`dialog`),t.setAttribute(`aria-modal`,`true`),t.setAttribute(`aria-labelledby`,`${C}-panel-title`),z$1.length||console.warn(`[AO3H][panel-ui] tab-registry not loaded — tab buttons may be missing`);let n=(e,t,n)=>`<button class="${C}-tab-btn${n?` ${C}-tab-active`:``}" data-tab="${e}" role="tab" aria-selected="${n?`true`:`false`}" id="${C}-tab-btn-${e}">${t}</button>`;return t.innerHTML=`
    <div style="display: flex; flex-direction: column; height: 100%;">
      <!-- Header -->
      <div class="${C}-panel-header">
        <h1 class="${C}-panel-title" id="${C}-panel-title">AO3 Helper Settings</h1>
        <button class="${C}-panel-close" aria-label="Close panel">×</button>
      </div>

      <!-- Tabs (generated from tab-registry + About) -->
      <div class="${C}-panel-tabs-container">
        <div class="${C}-panel-tabs-row" role="tablist" aria-label="AO3 Helper sections">
      ...
      <div class="${C}-global-search-wrapper">
        <div class="${C}-bulk-actions-buttons">
        ...
        <input type="text" id="${C}-global-search" class="${C}-global-search-input" placeholder="🔍 Search all modules..." autocomplete="off">
      </div>

      <!-- Body -->
      <div class="${C}-panel-body">
        <div id="${C}-tab-container" role="tabpanel" tabindex="0">
          <p style="color: #999; padding: 20px; text-align: center;">Loading...</p>
        </div>
      </div>
    </div>
  `,{backdrop:e,box:t}}function T(){let e=document.querySelector(`.${C}-panel-backdrop`),t=document.querySelector(`.${C}-panel-box`);e&&e.remove(),t&&t.remove();}function ne({id:e$1,title:t,desc:n}){return `
...
<div class="ao3h-tab-content" data-tab="about">
    <div style="max-width: 600px; margin: 0 auto; padding: 16px;">
        ...
        <div style="padding: 14px; background: #f9f9f9; border-radius: 8px; margin-bottom: 16px;">
            <p style="color: #555; line-height: 1.6; font-size: 13px; margin: 0;">AO3 Helper enhances your Archive of Our Own experience with ${ht$1.length} modules across ${z$1.length} categories — covering reading, filtering, bookmarking, navigation, appearance, and more.</p>
        </div>

        <div style="display: flex; gap: 12px; margin-bottom: 16px;">
            <div style="flex: 1; padding: 12px; background: #fff5f5; border-radius: 8px; text-align: center;">
                <div style="font-size: 24px; font-weight: 700; color: #900;">${ht$1.length}</div>
    ...
    `}var ie=Object.fromEntries([...z$1.map(e=>[e.id,E(e)]),[`about`,re()]]);console.log(`[AO3H][panel-tab-content] Tab content generated - ${z$1.length} tabs + About, ${ht$1.length} modules`);var D=`ficEngagement`,O=`
...
`,pe=typeof unsafeWindow<`u`?unsafeWindow:window,me=()=>{var e;return ((e=pe.AO3H)==null||(e=e.env)==null?void 0:e.NS)||`ao3h`},he=()=>Ee$1||null;function R(e,t){try{let n=he(),r=n?n.getJSON(e,null):JSON.parse(localStorage.getItem(`${me()}:${e}`)||`null`);return r==null?t:r}catch(e){return t}}function z(e,t){var n,r;try{let n=he();n?n.setJSON(e,t):localStorage.setItem(`${me()}:${e}`,JSON.stringify(t));}catch(e){}(n=pe.AO3H)==null||(n=n.store)==null||(r=n.set)==null||r.call(n,e,t);}function B(e,{lower:t=true}={}){return [...new Set(e.map(e=>t?e.trim().toLowerCase():e.trim()).filter(Boolean))]}var V=()=>R(`hideTags`,[]),ge=e=>z(`hideTags`,B(e)),H=()=>R(`hideTagsGroups`,{}),U=e=>{let t=new Set(V()),n={};for(let[r,i]of Object.entries(e||{})){let e=String(r).toLowerCase();t.has(e)&&(n[e]=String(i||``).trim());}z(`hideTagsGroups`,n);},W=()=>R(`hideTagsEmptyGroups`,[]),G=e=>z(`hideTagsEmptyGroups`,B(e,{lower:false})),_e=()=>R(`hideTagsWhitelist`,[]),ve=e=>z(`hideTagsWhitelist`,B(e)),ye=()=>R(`hideTagsNope`,[]),be=e=>z(`hideTagsNope`,B(e)),xe=()=>R(`hideTagsWhitelistGroups`,{}),Se=e=>z(`hideTagsWhitelistGroups`,e),Ce=()=>R(`hideTagsWhitelistEmptyGroups`,[]),we=e=>z(`hideTagsWhitelistEmptyGroups`,B(e,{lower:false})),Te=()=>R(`hideTagsNopeGroups`,{}),Ee=e=>z(`hideTagsNopeGroups`,e),De=()=>R(`hideTagsNopeEmptyGroups`,[]),K=e=>z(`hideTagsNopeEmptyGroups`,B(e,{lower:false})),Oe=new Set,ke=new Set,Ae=new Set;function je(e){let t=e.querySelector(`#ao3h-hideByTags-count`),n=e.querySelector(`#ao3h-hideByTags-whitelist-count`),r=e.querySelector(`#ao3h-hideByTags-nope-count`),i=V().length,a=_e().length,o=ye().length;t&&(t.textContent=i>0?`${i} hidden`:``),n&&(n.textContent=a>0?`${a} exception${a===1?``:`s`}`:``),r&&(r.textContent=o>0?`${o} word${o===1?``:`s`}`:``);}function q(e){let t=e.querySelector(`#ao3h-hideByTags-list`);if(!t)return;let n=e.querySelector(`#ao3h-hideByTags-groups`),r=e.querySelector(`#ao3h-hideByTags-search`),i=((r==null?void 0:r.value)||``).trim().toLowerCase(),a=V(),o=H(),s=W();{let t=(e.querySelector(`#ao3h-hideByTags-add-group`)||{}).value||``;ze(e,`ao3h-hideByTags-add-group`,[...new Set([...Object.values(o).map(e=>(e||``).trim()).filter(Boolean),...s.map(e=>(e||``).trim()).filter(Boolean)])].sort((e,t)=>e.localeCompare(t,void 0,{sensitivity:`base`})),t);}let c=i?a.filter(e=>e.includes(i)||(o[e]||``).toLowerCase().includes(i)):a,l=i?s.filter(e=>e.toLowerCase().includes(i)):s;if(c.length===0&&l.length===0){t.innerHTML=`
      ...
      </div>`,n&&(n.innerHTML=``);return}let u=new Map;for(let e of c){let t=(o[e]||``).trim()||`(ungrouped)`;u.has(t)||u.set(t,[]),u.get(t).push(e);}for(let e of l)u.has(e)||u.set(e,[]);let d=[...u.entries()].sort((e,t)=>e[0]===`(ungrouped)`?-1:t[0]===`(ungrouped)`?1:e[0].localeCompare(t[0],void 0,{sensitivity:`base`}));for(let[,e]of d)e.sort((e,t)=>e.localeCompare(t,void 0,{sensitivity:`base`}));let f=d.filter(([e])=>e!==`(ungrouped)`).length,p=e.querySelector(`#ao3h-hideByTags-count`);if(t.innerHTML=``,n&&(n.innerHTML=``,f>0)){let e=document.createElement(`div`);e.className=`ao3h-hbt-groups-inner`,n.appendChild(e);}for(let[r,i]of d){var m;let a=r===`(ungrouped)`,o=a||Oe.has(r),s=document.createElement(`div`);if(s.className=a?`ao3h-hbt-group`:`ao3h-hbt-group ao3h-hbt-group--named`,s.setAttribute(`aria-expanded`,String(o)),!a){let t=document.createElement(`div`);t.className=`ao3h-hbt-group-header`,t.innerHTML=`
...
Tags will be kept but ungrouped.`)&&(t.saveGroupsMap({}),t.saveEmptyGroups([]),t.rerenderFn(e));}),n.appendChild(a),r.appendChild(n);}}function Ne(e){Me(e,{listId:`ao3h-hideByTags-whitelist-list`,groupsId:`ao3h-hideByTags-whitelist-groups`,groupSelectId:`ao3h-hideByTags-whitelist-add-group`,countId:`ao3h-hideByTags-whitelist-count`,getItems:_e,getGroupsMap:xe,saveGroupsMap:Se,getEmptyGroups:Ce,saveEmptyGroups:we,expandedSet:ke,emptyFreshMsg:`No whitelist exceptions yet.`,label:`exception`,clearFn:()=>{ve([]),Se({}),we([]);},clearMsg:`Clear all whitelist exceptions?
This cannot be undone.`,makeChipFn:(e,t)=>Fe(e,t,{getItems:_e,saveItems:ve,getGroupsMap:xe,saveGroupsMap:Se,getEmptyGroups:Ce,saveEmptyGroups:we,expandedSet:ke,rerenderFn:Ne}),rerenderFn:Ne}),je(e);}function Pe(e){Me(e,{listId:`ao3h-hideByTags-nope-list`,groupsId:`ao3h-hideByTags-nope-groups`,groupSelectId:`ao3h-hideByTags-nope-add-group`,countId:`ao3h-hideByTags-nope-count`,getItems:ye,getGroupsMap:Te,saveGroupsMap:Ee,getEmptyGroups:De,saveEmptyGroups:K,expandedSet:Ae,emptyFreshMsg:`No NOPE words yet.`,label:`word`,clearFn:()=>{be([]),Ee({}),K([]);},clearMsg:`Clear all NOPE words?
This cannot be undone.`,makeChipFn:(e,t)=>Fe(e,t,{getItems:ye,saveItems:be,getGroupsMap:Te,saveGroupsMap:Ee,getEmptyGroups:De,saveEmptyGroups:K,expandedSet:Ae,rerenderFn:Pe}),rerenderFn:Pe}),je(e);}function Fe(e,t,n){let r=document.createElement(`span`);r.className=`ao3h-tag-chip`;let i=document.createElement(`span`);i.className=`ao3h-tag-chip-text`,i.textContent=e,i.title=e;let a=document.createElement(`button`);a.type=`button`,a.className=`ao3h-tag-chip-group`,a.title=`Change group`,a.textContent=`📁`,a.addEventListener(`click`,r=>{r.stopPropagation(),Le(a,e,t,n);});let o=document.createElement(`button`);return o.type=`button`,o.className=`ao3h-tag-chip-remove`,o.title=`Remove`,o.textContent=`×`,o.addEventListener(`click`,r=>{r.stopPropagation(),n.saveItems(n.getItems().filter(t=>t!==e));let i=n.getGroupsMap();delete i[e],n.saveGroupsMap(i),n.rerenderFn(t);}),r.append(i,a,o),r}function Ie(e,t){let n=document.createElement(`span`);n.className=`ao3h-tag-chip`;let r=document.createElement(`span`);r.className=`ao3h-tag-chip-text`,r.textContent=e,r.title=e;let i=document.createElement(`button`);i.type=`button`,i.className=`ao3h-tag-chip-group`,i.title=`Change group`,i.textContent=`📁`,i.addEventListener(`click`,n=>{n.stopPropagation(),Re(i,e,t);});let a=document.createElement(`button`);return a.type=`button`,a.className=`ao3h-tag-chip-remove`,a.title=`Remove`,a.textContent=`×`,a.addEventListener(`click`,n=>{n.stopPropagation(),ge(V().filter(t=>t!==e));let r=H();delete r[e],U(r),q(t);}),n.append(r,i,a),n}function Le(e,t,n,r){document.querySelectorAll(`.ao3h-hbt-group-picker--floating`).forEach(e=>e.remove());let i=r.getGroupsMap(),a=(i[t]||``).trim(),o=r.getEmptyGroups(),s=[...new Set([...Object.values(i).map(e=>(e||``).trim()).filter(Boolean),...o.map(e=>(e||``).trim()).filter(Boolean)])].sort((e,t)=>e.localeCompare(t,void 0,{sensitivity:`base`})),c=document.createElement(`div`);c.className=`ao3h-hbt-group-picker ao3h-hbt-group-picker--floating`,c.innerHTML=`
    ...
    <button class="ao3h-inline-btn ao3h-hbt-gp-close">Close</button>`,document.body.appendChild(s);let c=e.getBoundingClientRect();Object.assign(s.style,{position:`fixed`,zIndex:`1000000`,left:`${c.left}px`,top:`${c.bottom+4}px`}),requestAnimationFrame(()=>{let e=s.getBoundingClientRect();e.right>window.innerWidth-8&&(s.style.left=`${window.innerWidth-e.width-8}px`),e.bottom>window.innerHeight-8&&(s.style.top=`${c.top-e.height-4}px`);});function l(){s.remove(),document.removeEventListener(`click`,u,true);}function u(t){!s.contains(t.target)&&t.target!==e&&l();}setTimeout(()=>document.addEventListener(`click`,u,true),0);function d(e){let r=H();e?r[t]=e:delete r[t],U(r),e&&G(W().filter(t=>t!==e)),l(),q(n);}s.querySelectorAll(`.ao3h-hbt-gp-item`).forEach(e=>e.addEventListener(`click`,()=>d(e.dataset.group)));let f=s.querySelector(`.ao3h-hbt-gp-input`),p=s.querySelector(`.ao3h-hbt-gp-add`);function m(){let e=f.value.trim();e&&d(e);}p.addEventListener(`click`,m),f.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),m());}),s.querySelector(`.ao3h-hbt-gp-ungroup`).addEventListener(`click`,()=>d(``)),s.querySelector(`.ao3h-hbt-gp-close`).addEventListener(`click`,l),f.focus();}function ze(e,t,n,r){let i=e.querySelector(`#${t}`);if(!i)return;i.style.display=`none`;let a=`${t}-custom`,o=e.querySelector(`#${a}`);if(!o){o=document.createElement(`div`),o.className=`ao3h-group-select`,o.id=a;let e=i.style;e.flex&&(o.style.flex=e.flex),e.minWidth&&(o.style.minWidth=e.minWidth);let t=document.createElement(`button`);t.type=`button`,t.className=`ao3h-group-select__trigger ao3h-config-input`;let n=document.createElement(`div`);n.className=`ao3h-group-select__panel`,n.hidden=true,t.addEventListener(`click`,e=>{e.stopPropagation(),document.querySelectorAll(`.ao3h-group-select__panel`).forEach(e=>{e!==n&&(e.hidden=true);}),n.hidden=!n.hidden;}),o.appendChild(t),o.appendChild(n),i.insertAdjacentElement(`afterend`,o),o.dataset.outsideWired||(o.dataset.outsideWired=`1`,document.addEventListener(`click`,()=>{n.hidden=true;}));}let s=o.querySelector(`.ao3h-group-select__trigger`),c=o.querySelector(`.ao3h-group-select__panel`);function l(e){i.value=e,s.textContent=e===`__new__`?`+ New group`:e||`Group (optional)`,s.classList.toggle(`ao3h-group-select__trigger--active`,!!e),c.querySelectorAll(`.ao3h-group-select__option`).forEach(t=>t.classList.toggle(`ao3h-group-select__option--selected`,t.dataset.value===e)),i.dispatchEvent(new Event(`change`));}c.innerHTML=``;for(let e of [{value:``,label:`Group (optional)`},...n.map(e=>({value:e,label:e}))]){let t=document.createElement(`div`);t.className=`ao3h-group-select__option`+(e.value===r?` ao3h-group-select__option--selected`:``),t.textContent=e.label,t.dataset.value=e.value,t.addEventListener(`click`,()=>{l(e.value),c.hidden=true;}),c.appendChild(t);}let u=document.createElement(`div`);u.className=`ao3h-group-select__option ao3h-group-select__option--new`+(r===`__new__`?` ao3h-group-select__option--selected`:``),u.textContent=`+ New group`,u.dataset.value=`__new__`,u.addEventListener(`click`,()=>{l(`__new__`),c.hidden=true;}),c.appendChild(u),s.textContent=r===`__new__`?`+ New group`:r||`Group (optional)`,s.classList.toggle(`ao3h-group-select__trigger--active`,!!r);}var Be={_v:2,enabled:true,quickAddIcon:true,showHiddenCounter:true,hideMode:`hide`,tagMatchMode:`exact`,whitelistEnabled:true,showWhitelistBadge:true,whitelistMode:`show`,textFilterEnabled:true,nopeHideMode:`hide`,nopeWholeWords:false,nopeTargetSummaries:true,nopeTargetNotes:true,nopeTargetTitles:false,dimOpacity:25,dimBlur:false,protectBookmarked:false,hideNoiseTaggedWorks:false};function Ve(){try{let i=`${me()}:mod:hideByTags:settings`,a=localStorage.getItem(i),o=a?JSON.parse(a):null;if(!o||typeof o!=`object`){var e,t;localStorage.setItem(i,JSON.stringify(Be)),(e=pe.AO3H)==null||(e=e.store)==null||(t=e.set)==null||t.call(e,`mod:hideByTags:settings`,Be);return}if(!o._v||o._v<2){var n,r;o.whitelistEnabled===!1&&(o.whitelistEnabled=!0),o.textFilterEnabled===!1&&(o.textFilterEnabled=!0),o._v=2,localStorage.setItem(i,JSON.stringify(o)),(n=pe.AO3H)==null||(n=n.store)==null||(r=n.set)==null||r.call(n,`mod:hideByTags:settings`,o);}}catch(e){}}function He(e){Ve(),q(e);let t=e.closest(`.ao3h-module-row`)||e.closest(`[data-module]`),n$1=t==null?void 0:t.querySelector(`input[type="checkbox"].ao3h-module-toggle, .ao3h-module-enable-toggle input`),r=e.querySelector(`[data-setting="enabled"]`),i$1=e.querySelector(`[data-setting="whitelistEnabled"]`),a=e.querySelector(`[data-setting="textFilterEnabled"]`),o=e.querySelector(`#ao3h-hideByTags-section-body`),s=e.querySelector(`#ao3h-hideByTags-below`),c=e.querySelector(`#ao3h-hideByTags-whitelist-body`),l=e.querySelector(`#ao3h-hideByTags-nope-body`),u=e.querySelector(`#ao3h-hideByTags-whitelist-behavior`),d=e.querySelector(`#ao3h-hideByTags-nope-behavior`),f=e.querySelector(`#ao3h-hideByTags-whitelist-below`),h=e.querySelector(`#ao3h-hideByTags-nope-below`);function g(e,t){e==null||e.classList.toggle(`ao3h-section-disabled`,t);}function _(){var t,p;let m=!(r!=null&&r.checked),_=!(i$1!=null&&i$1.checked),v=!(a!=null&&a.checked);if(g(o,m),g(s,m),g((t=e.querySelector(`[data-setting="quickAddIcon"]`))==null?void 0:t.closest(`label`),m),g((p=e.querySelector(`[data-setting="showWhitelistBadge"]`))==null?void 0:p.closest(`label`),_),g(c,_),g(u,_),g(f,_),g(l,v),g(d,v),g(h,v),n$1){let e=m&&_&&v;e&&n$1.checked?(n$1.checked=false,n$1.dispatchEvent(new Event(`change`,{bubbles:true}))):!e&&!n$1.checked&&(n$1.checked=true,n$1.dispatchEvent(new Event(`change`,{bubbles:true})));}}for(let e of [r,i$1,a])e&&!e.dataset.disableWired&&(e.dataset.disableWired=`1`,e.addEventListener(`change`,_));_();let v=e.querySelector(`#ao3h-hideByTags-search`);if(v&&!v.dataset.wired){v.dataset.wired=`1`;let t;v.addEventListener(`input`,()=>{clearTimeout(t),t=setTimeout(()=>q(e),150);});}let y=e.querySelector(`#ao3h-hideByTags-add-input`),b=e.querySelector(`#ao3h-hideByTags-add-group`),x=e.querySelector(`#ao3h-hideByTags-add-group-text`),ee=e.querySelector(`[data-action="add-tag"]`);function te(){let t=((y==null?void 0:y.value)||``).trim().toLowerCase(),n=(b==null?void 0:b.value)===`__new__`?((x==null?void 0:x.value)||``).trim():((b==null?void 0:b.value)||``).trim();if(!t)return;let r=V();if(r.includes(t)||(r.push(t),ge(r)),n){let e=H();e[t]=n,U(e),G(W().filter(e=>e!==n));}y&&(y.value=``),(b==null?void 0:b.value)===`__new__`&&(x&&(x.value=``,x.style.display=`none`),b&&(b.value=``)),q(e);}b&&!b.dataset.wired&&(b.dataset.wired=`1`,b.addEventListener(`change`,()=>{if(!x)return;let e=b.value===`__new__`;x.style.display=e?`block`:`none`,e&&x.focus();})),x&&!x.dataset.wired&&(x.dataset.wired=`1`,x.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),te());})),y&&!y.dataset.wired&&(y.dataset.wired=`1`,y.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),te());})),ee&&!ee.dataset.wired&&(ee.dataset.wired=`1`,ee.addEventListener(`click`,e=>{e.preventDefault(),te();})),Ne(e),Pe(e);let S=e.querySelector(`#ao3h-hideByTags-whitelist-add-input`),C=e.querySelector(`#ao3h-hideByTags-whitelist-add-group`),w=e.querySelector(`#ao3h-hideByTags-whitelist-add-group-text`),T=e.querySelector(`[data-action="add-whitelist-tag"]`);function ne(){let t=((S==null?void 0:S.value)||``).trim().toLowerCase(),n=(C==null?void 0:C.value)===`__new__`?((w==null?void 0:w.value)||``).trim():((C==null?void 0:C.value)||``).trim();if(!t)return;let r=_e();if(r.includes(t)||(r.push(t),ve(r)),n){let e=xe();e[t]=n,Se(e),we(Ce().filter(e=>e!==n));}S&&(S.value=``),(C==null?void 0:C.value)===`__new__`&&(w&&(w.value=``,w.style.display=`none`),C&&(C.value=``)),Ne(e);}C&&!C.dataset.wired&&(C.dataset.wired=`1`,C.addEventListener(`change`,()=>{if(!w)return;let e=C.value===`__new__`;w.style.display=e?`block`:`none`,e&&w.focus();})),w&&!w.dataset.wired&&(w.dataset.wired=`1`,w.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),ne());})),S&&!S.dataset.wired&&(S.dataset.wired=`1`,S.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),ne());})),T&&!T.dataset.wired&&(T.dataset.wired=`1`,T.addEventListener(`click`,e=>{e.preventDefault(),ne();}));let E=e.querySelector(`#ao3h-hideByTags-whitelist-new-group`),re=e.querySelector(`[data-action="add-whitelist-group"]`);function ie(){let t=((E==null?void 0:E.value)||``).trim();if(!t)return;let n=Ce();n.includes(t)||(n.push(t),we(n)),ke.add(t),E&&(E.value=``),Ne(e);}E&&!E.dataset.wired&&(E.dataset.wired=`1`,E.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),ie());})),re&&!re.dataset.wired&&(re.dataset.wired=`1`,re.addEventListener(`click`,e=>{e.preventDefault(),ie();}));let D=e.querySelector(`#ao3h-hideByTags-nope-add-input`),O=e.querySelector(`#ao3h-hideByTags-nope-add-group`),k=e.querySelector(`#ao3h-hideByTags-nope-add-group-text`),ae=e.querySelector(`[data-action="add-nope-word"]`);function oe(){let t=((D==null?void 0:D.value)||``).trim().toLowerCase(),n=(O==null?void 0:O.value)===`__new__`?((k==null?void 0:k.value)||``).trim():((O==null?void 0:O.value)||``).trim();if(!t)return;let r=ye();if(r.includes(t)||(r.push(t),be(r)),n){let e=Te();e[t]=n,Ee(e),K(De().filter(e=>e!==n));}D&&(D.value=``),(O==null?void 0:O.value)===`__new__`&&(k&&(k.value=``,k.style.display=`none`),O&&(O.value=``)),Pe(e);}O&&!O.dataset.wired&&(O.dataset.wired=`1`,O.addEventListener(`change`,()=>{if(!k)return;let e=O.value===`__new__`;k.style.display=e?`block`:`none`,e&&k.focus();})),k&&!k.dataset.wired&&(k.dataset.wired=`1`,k.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),oe());})),D&&!D.dataset.wired&&(D.dataset.wired=`1`,D.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),oe());})),ae&&!ae.dataset.wired&&(ae.dataset.wired=`1`,ae.addEventListener(`click`,e=>{e.preventDefault(),oe();}));let A=e.querySelector(`#ao3h-hideByTags-nope-new-group`),j=e.querySelector(`[data-action="add-nope-group"]`);function se(){let t=((A==null?void 0:A.value)||``).trim();if(!t)return;let n=De();n.includes(t)||(n.push(t),K(n)),Ae.add(t),A&&(A.value=``),Pe(e);}A&&!A.dataset.wired&&(A.dataset.wired=`1`,A.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),se());})),j&&!j.dataset.wired&&(j.dataset.wired=`1`,j.addEventListener(`click`,e=>{e.preventDefault(),se();}));function ce(e,t){n(e,t);}function M(e){i().then(t=>{t!=null&&e(t);}).catch(()=>alert(`Invalid JSON file.`));}let N=e.querySelector(`[data-action="export-all"]`);N&&!N.dataset.wired&&(N.dataset.wired=`1`,N.addEventListener(`click`,e=>{e.preventDefault(),ce({tags:V(),groups:H(),emptyGroups:W()},`ao3h-hidden-tags.json`);}));let le=e.querySelector(`[data-action="import-all"]`);le&&!le.dataset.wired&&(le.dataset.wired=`1`,le.addEventListener(`click`,t=>{t.preventDefault(),M(t=>{t.tags&&ge(t.tags),t.groups&&U(t.groups),t.emptyGroups&&G(t.emptyGroups),q(e);});}));let ue=e.querySelector(`[data-action="export-whitelist"]`);ue&&!ue.dataset.wired&&(ue.dataset.wired=`1`,ue.addEventListener(`click`,e=>{e.preventDefault(),ce({tags:_e(),groups:xe(),emptyGroups:Ce()},`ao3h-whitelist.json`);}));let de=e.querySelector(`[data-action="import-whitelist"]`);de&&!de.dataset.wired&&(de.dataset.wired=`1`,de.addEventListener(`click`,t=>{t.preventDefault(),M(t=>{Array.isArray(t)?ve(t):t!=null&&t.tags&&(ve(t.tags),t.groups&&Se(t.groups),t.emptyGroups&&we(t.emptyGroups)),Ne(e);});}));let P=e.querySelector(`[data-action="export-nope"]`);P&&!P.dataset.wired&&(P.dataset.wired=`1`,P.addEventListener(`click`,e=>{e.preventDefault(),ce({tags:ye(),groups:Te(),emptyGroups:De()},`ao3h-nope-words.json`);}));let F=e.querySelector(`[data-action="import-nope"]`);F&&!F.dataset.wired&&(F.dataset.wired=`1`,F.addEventListener(`click`,t=>{t.preventDefault(),M(t=>{Array.isArray(t)?be(t):t!=null&&t.tags&&(be(t.tags),t.groups&&Ee(t.groups),t.emptyGroups&&K(t.emptyGroups)),Pe(e);});}));let I=e.querySelector(`#ao3h-hideByTags-new-group`),L=e.querySelector(`[data-action="add-group"]`);function fe(){let t=((I==null?void 0:I.value)||``).trim();if(!t)return;let n=W();n.includes(t)||(n.push(t),G(n)),Oe.add(t),I&&(I.value=``),q(e);}I&&!I.dataset.wired&&(I.dataset.wired=`1`,I.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),fe());})),L&&!L.dataset.wired&&(L.dataset.wired=`1`,L.addEventListener(`click`,e=>{e.preventDefault(),fe();}));}document.addEventListener(`ao3h:configOpen`,e=>{var t;((t=e.detail)==null?void 0:t.moduleId)===`hideByTags`&&He(e.target);});var Ue=`pageControls`,We=`
...
`;function Je(e,t){let n=Array.isArray(e)?e:[],r=String(t||``).trim().toLowerCase();return r?n.filter(e=>{if(!e)return  false;let t=String(e.workId||``).replace(/^\/works\//,``).split(`/`)[0];return [e.title,e.author,e.reason,e.workId,t].filter(Boolean).join(` `).toLowerCase().includes(r)}):n}var Ye=((Ge=(typeof unsafeWindow<`u`?unsafeWindow:window).AO3H)==null||(Ge=Ge.env)==null?void 0:Ge.NS)||`ao3h`,Xe=Ee$1||null,Ze=`m5QuickTagsUser`,J=`works`;function Qe(){return Se$1()||`guest`}var $e=null;function et(){return new Promise((e,t)=>{if($e){e($e);return}let n=`ao3h-hiddenWorksDB-${Qe()}`,r=indexedDB.open(n,1);r.onupgradeneeded=()=>{let e=r.result;if(!e.objectStoreNames.contains(J)){let t=e.createObjectStore(J,{keyPath:`workId`});t.createIndex(`reason`,`reason`,{unique:false}),t.createIndex(`isHidden`,`isHidden`,{unique:false});}},r.onsuccess=()=>{$e=r.result,e($e);},r.onerror=()=>t(r.error);})}function tt(){return nt.apply(this,arguments)}function nt(){return nt=t(function*(){let e=yield et();return new Promise((t,n)=>{let r=e.transaction(J,`readonly`).objectStore(J).getAll();r.onsuccess=()=>t(r.result||[]),r.onerror=()=>n(r.error);})}),nt.apply(this,arguments)}function rt(e){return it.apply(this,arguments)}function it(){return it=t(function*(e){let t=yield et();return new Promise((n,r)=>{let i=t.transaction(J,`readonly`).objectStore(J).get(e);i.onsuccess=()=>n(i.result||null),i.onerror=()=>r(i.error);})}),it.apply(this,arguments)}function at(e){return ot.apply(this,arguments)}function ot(){return ot=t(function*(e){let t=yield et();return new Promise((n,r)=>{let i=t.transaction(J,`readwrite`).objectStore(J).put(e);i.onsuccess=()=>n(),i.onerror=()=>r(i.error);})}),ot.apply(this,arguments)}var st=[`crossover`,`sequel`,`bad summary`,`parent/dad`,`unfinished`,`growing up together`,`not sterek focused`,`1rst pov`,`established`,`always-a-girl`,`remember reading`,`implied`];function ct(){try{let e=Xe?Xe.getJSON(Ze,null):JSON.parse(localStorage.getItem(`${Ye}:${Ze}`)||`null`);return Array.isArray(e)?e:st}catch(e){return []}}function lt(e){try{Xe?Xe.setJSON(Ze,e):localStorage.setItem(`${Ye}:${Ze}`,JSON.stringify(e));}catch(e){}}function ut(e){return dt.apply(this,arguments)}function dt(){return dt=t(function*(t$1,n=``){let r=t$1||document,i=r.querySelector(`#ao3h-skipWorks-list-container`)||document.getElementById(`ao3h-skipWorks-list-container`),a=r.querySelector(`#ao3h-skipWorks-count`)||document.getElementById(`ao3h-skipWorks-count`);if(!i)return;let o;try{o=yield tt();}catch(e){console.error(`[AO3H][skipWorks-config] Failed to load works list:`,e),i.innerHTML=`<p style="color:#c00;font-size:11px;padding:6px 0;margin:0;">⚠ Could not load skipped works list (${(e==null?void 0:e.message)||e}).</p>`;return}let s=o.filter(e=>e.isHidden),c=Je(s,n);if(a&&(a.textContent=n.trim()?`${c.length} of ${s.length} work${s.length===1?``:`s`} skipped`:`${s.length} work${s.length===1?``:`s`} skipped`),s.length===0){i.innerHTML=`<p style="color:#bbb;font-size:11px;font-style:italic;padding:6px 0;margin:0;">No works skipped yet.</p>`;return}if(c.length===0){i.innerHTML=`<p style="color:#bbb;font-size:11px;font-style:italic;padding:6px 0;margin:0;">No skipped works match “${e(n.trim())}”.</p>`;return}let l=document.createElement(`div`);l.className=`ao3h-module-list ao3h-skipworks-list`;for(let e$1 of c){let t=e$1.workId.replace(/^\/works\//,``).split(`/`)[0],n=document.createElement(`div`);n.className=`ao3h-module-list-entry ao3h-skipworks-entry`,n.dataset.workId=e$1.workId,n.innerHTML=`
      ...
      </div>`,a.appendChild(n);}n.innerHTML=``,n.appendChild(a),n.dataset.removeNoteWired||(n.dataset.removeNoteWired=`1`,n.addEventListener(`click`,function(){var n=t(function*(e){let n=e.target.closest(`[data-action="remove-note"]`);if(!n)return;let r=n.closest(`.ao3h-skipworks-entry`).dataset.workId;if(!confirm(`Remove this private note?`))return;let i=yield rt(r);i&&(i.reason=``,i.isStandaloneNote=false,yield at(i)),yield pt(t$1);});return function(e){return n.apply(this,arguments)}}()));}),mt.apply(this,arguments)}function ht(e){let t=e?e.querySelector(`#ao3h-skipWorks-presets-container`):document.getElementById(`ao3h-skipWorks-presets-container`);if(!t)return;function n(){let e=ct();t.innerHTML=`
      ...
      </div>`;let r=t.querySelector(`.ao3h-skipworks-preset-input`),i=t.querySelector(`.ao3h-sw-preset-add`),a=t.querySelector(`.ao3h-skipworks-presets`);function o(){let e=r.value.trim();if(!e)return;let t=ct();t.includes(e)||(t.push(e),lt(t)),r.value=``,n();}i.addEventListener(`click`,o),r.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),o());}),a.querySelectorAll(`button[data-preset]`).forEach(e=>{e.addEventListener(`click`,()=>{lt(ct().filter(t=>t!==e.dataset.preset)),n();});});}n();}function gt(t$1){let n=t$1.querySelector(`[data-action="clear-all"]`),r=t$1.querySelector(`[data-action="export-list"]`);n&&!n.dataset.swWired&&(n.dataset.swWired=`1`,n.addEventListener(`click`,function(){var n=t(function*(e){if(e.stopPropagation(),!confirm(`Clear all skipped works? This cannot be undone.`))return;let n=yield tt();for(let e of n)e.isHidden=false,yield at(e);yield ut(t$1),gt(t$1);});return function(e){return n.apply(this,arguments)}}())),r&&!r.dataset.swWired&&(r.dataset.swWired=`1`,r.addEventListener(`click`,function(){var t$1=t(function*(e){e.stopPropagation();let t=(yield tt()).filter(e=>e.isHidden),n=new Blob([JSON.stringify(t,null,2)],{type:`application/json`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=`ao3h-skipped-works.json`,i.click(),setTimeout(()=>URL.revokeObjectURL(r),1e3);});return function(e){return t$1.apply(this,arguments)}}()));let i=t$1.querySelector(`[data-action="import-list"]`);i&&!i.dataset.swWired&&(i.dataset.swWired=`1`,i.addEventListener(`click`,n=>{n.stopPropagation();let r=document.createElement(`input`);r.type=`file`,r.accept=`application/json`,r.addEventListener(`change`,t(function*(){var e;let n=(e=r.files)==null?void 0:e[0];if(n)try{let e=yield n.text(),r=JSON.parse(e);if(!Array.isArray(r))throw Error(`Not an array`);for(let e of r)e.workId&&(yield at(e));yield ut(t$1),gt(t$1);}catch(e){alert(`Import failed: please select a valid JSON export file.`);}}),{once:true}),r.click();}));}function _t(e){try{let t=localStorage.getItem(`ao3h:mod:skipWorks:settings`);if(!t)return;let n=JSON.parse(t);e.querySelectorAll(`[data-setting]`).forEach(e=>{let t=e.dataset.setting;t in n&&(e.type===`checkbox`?e.checked=!!n[t]:e.type===`radio`?e.checked=e.value===n[t]:e.value=n[t]);});}catch(e){}}function vt(e){let t=e.querySelector(`#ao3h-skipWorks-search`);!t||t.dataset.swWired||(t.dataset.swWired=`1`,t.addEventListener(`input`,nt$1(()=>{ut(e,t.value);},200)));}document.addEventListener(`ao3h:configOpen`,e=>{var t,n;if(((t=e.detail)==null?void 0:t.moduleId)!==`skipWorks`)return;let r=(n=e.detail)==null?void 0:n.configArea;r&&(_t(r),ut(r,ft(r)),ht(r),pt(r),gt(r),vt(r));});var yt=`tagsDisplay`,bt=`
...
`,xt=`ao3h:tagsDisplay:noiseAuthorExceptions`;function St(e){try{let t=localStorage.getItem(e),n=t?JSON.parse(t):[];return Array.isArray(n)?n.filter(e=>typeof e==`string`):[]}catch(e){return []}}function Ct(e,t){let n=Array.from(new Set(t.map(e=>String(e||``).trim().toLowerCase()).filter(Boolean)));try{localStorage.setItem(e,JSON.stringify(n));}catch(e){}return n}var wt=()=>St(xt),Tt=e=>Ct(xt,e);function Et(e$1,{getList:t,saveList:n,placeholder:r,emptyText:i}){if(!e$1)return;function a(){let o=t();e$1.innerHTML=`
      <div class="ao3h-config-row">
...
`,Kt=`ao3h:rt:history`,qt=`ao3h:rt:excludedWorks`;function Jt(){try{return JSON.parse(localStorage.getItem(Kt)||`[]`)}catch(e){return []}}function Yt(e){try{localStorage.setItem(Kt,JSON.stringify(e));}catch(e){}}function Xt(){try{return JSON.parse(localStorage.getItem(qt)||`[]`)}catch(e){return []}}function Zt(e){try{localStorage.setItem(qt,JSON.stringify(e));}catch(e){}}function Y(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Qt(e){return e$1(e)||``}function $t(e){let t=new Date(Date.now());t.setHours(0,0,0,0);let n=t.getTime(),r=n-864e5,i=n-7*864e5,a={Today:[],Yesterday:[],"This week":[],Older:[]};for(let t of e){let e=t.lastReadAt||t.seenAt||0;e>=n?a.Today.push(t):e>=r?a.Yesterday.push(t):e>=i?a[`This week`].push(t):a.Older.push(t);}return a}function en(e,t){let n=t.trim().toLowerCase();return n?e.filter(e=>(e.title||``).toLowerCase().includes(n)||(e.author||``).toLowerCase().includes(n)):e}function tn(e,t){return [...e].sort((e,n)=>t===`title`?(e.title||``).localeCompare(n.title||``):(n.lastReadAt||n.seenAt||0)-(e.lastReadAt||e.seenAt||0))}function nn(e){return [...e.filter(e=>e.pinned),...e.filter(e=>!e.pinned)]}function rn(e,t){let n=Date.now()-t*864e5;return e.filter(e=>!e.pinned&&(e.lastReadAt||e.seenAt||0)<n).map(e=>e.id).filter(Boolean)}function an(e){let t=e.lastReadAt||e.seenAt;return `
    <li class="ao3h-rt-history-entry" data-id="${Y(e.id)}">
      ...
      <span class="ao3h-rt-entry-meta">${Y(e.author||``)}${e.visitCount>1?` · read ${e.visitCount}×`:``} · ${Qt(t)}</span>
      ${e.note?`<span class="ao3h-rt-entry-note" title="${Y(e.note)}">📝</span>`:``}
      <button type="button" class="ao3h-rt-note-btn" data-action="rt-note" title="Add/edit note">✎</button>
      <button type="button" class="ao3h-rt-delete-btn" data-action="delete-entry" data-work-id="${Y(e.id)}" aria-label="Delete entry">✕</button>
    </li>`}function on(e){let t=document.getElementById(`ao3h-rt-search`),n=document.getElementById(`ao3h-rt-sort`),r=document.getElementById(`ao3h-rt-group-period`);if(!t||!n||!r)return;let i=n.value,a=en(Jt(),t.value);if(a=nn(tn(a,i)),!a.length){e.innerHTML=`<p class="ao3h-rt-history-empty">No matching history entries.</p>`;return}if(r.checked&&i===`date`){let t=$t(a);e.innerHTML=Object.entries(t).filter(([,e])=>e.length).map(([e,t])=>`
        <div class="ao3h-rt-history-group">
          <div class="ao3h-rt-history-group-label">${e}</div>
          <ul>${t.map(an).join(``)}</ul>
        </div>`).join(``);}else e.innerHTML=`<ul>${a.map(an).join(``)}</ul>`;}function sn(e){let t=document.getElementById(`ao3h-rt-exclusion-list`);if(!t)return;let n=Xt();if(!n.length){t.innerHTML=`<li class="ao3h-rt-exclusion-empty">None</li>`;return}t.innerHTML=n.map(e=>`
    <li>${Y(e.replace(/^fandom:/,``))}${e.startsWith(`fandom:`)?` (fandom)`:` (work ID)`}
      <button type="button" class="ao3h-rt-exclusion-remove" data-value="${Y(e)}" aria-label="Remove">✕</button>
    </li>`).join(``),t.querySelectorAll(`.ao3h-rt-exclusion-remove`).forEach(t=>{t.addEventListener(`click`,()=>{Zt(Xt().filter(e=>e!==t.dataset.value)),sn();});});}function cn(e){let t=e.querySelector(`#ao3h-rt-history-list`);if(t&&!t.dataset.wired){var n,i,a;t.dataset.wired=`1`;let o=()=>on(t);(n=e.querySelector(`#ao3h-rt-search`))==null||n.addEventListener(`input`,o),(i=e.querySelector(`#ao3h-rt-sort`))==null||i.addEventListener(`change`,o),(a=e.querySelector(`#ao3h-rt-group-period`))==null||a.addEventListener(`change`,o),t.addEventListener(`click`,e=>{var t;let n=e.target.closest(`[data-action="rt-pin"]`),i=e.target.closest(`[data-action="rt-note"]`),a=e.target.closest(`[data-action="delete-entry"]`),s=(t=e.target.closest(`.ao3h-rt-history-entry`))==null?void 0:t.dataset.id;if(s)if(n)Yt(Jt().map(e=>e.id===s?d$1(d$1({},e),{},{pinned:!e.pinned}):e)),o();else if(i){let e=Jt(),t=e.find(e=>e.id===s),n=window.prompt(`Personal note for this entry:`,(t==null?void 0:t.note)||``);if(n===null)return;Yt(e.map(e=>e.id===s?d$1(d$1({},e),{},{note:n.trim()||void 0}):e)),o();}else a&&(Yt(Jt().filter(e=>e.id!==s)),o());}),o();}let o=e.querySelector(`[data-action="rt-cleanup"]`);o&&!o.dataset.wired&&(o.dataset.wired=`1`,o.addEventListener(`click`,()=>{var n;let r=parseInt((n=e.querySelector(`#ao3h-rt-cleanup-days`))==null?void 0:n.value,10);if(!r||r<=0){window.alert(`Enter a number of days first.`);return}let i=Jt(),a=new Set(rn(i,r)),o=i.filter(e=>!a.has(e.id)),s=i.length-o.length;Yt(o),t&&on(t),window.alert(`Removed ${s} entr${s===1?`y`:`ies`} older than ${r} days (pinned entries kept).`);}));let s=e.querySelector(`[data-action="rt-add-exclusion"]`);s&&!s.dataset.wired&&(s.dataset.wired=`1`,sn(),s.addEventListener(`click`,()=>{let t=e.querySelector(`#ao3h-rt-exclude-input`),n=t==null?void 0:t.value.trim();if(!n)return;let r=/^\d+$/.test(n)?n:`fandom:${n}`,i=Xt();i.includes(r)||Zt([...i,r]),t.value=``,sn();}));}document.addEventListener(`ao3h:configOpen`,function(e){var t;((t=e.detail)==null?void 0:t.moduleId)===`readingTracker`&&cn(e.target);});var ln=`textToSpeech`,un=`
...
`,_n=`keyboardShortcuts`,vn=[`prevChapter`,`nextChapter`,`prevPage`,`nextPage`,`firstPage`,`lastPage`,`jumpBackPages`,`jumpForwardPages`,`guide`,`commandPalette`,`surpriseMe`,`subscribe`,`bookmark`,`markForLater`,`kudos`],yn=`
...
`;function bn(t$1){let n$1=t$1.querySelector(`[data-action="export-shortcuts"]`);n$1&&!n$1.dataset.wired&&(n$1.dataset.wired=`1`,n$1.addEventListener(`click`,()=>{let e=a$1(_n),t={};vn.forEach(n=>{n in e&&(t[n]=e[n]);}),n(t,`ao3h-keyboard-shortcuts.json`);}));let r=t$1.querySelector(`[data-action="import-shortcuts"]`);r&&!r.dataset.wired&&(r.dataset.wired=`1`,r.addEventListener(`click`,t(function*(){let e;try{e=yield i();}catch(e){alert(`Import failed: invalid JSON file.`);return}if(!e||typeof e!=`object`)return;let n={};if(vn.forEach(t=>{typeof e[t]==`string`&&(n[t]=e[t]);}),!Object.keys(n).length){alert(`No recognized shortcut keys found in file.`);return}s(_n,n),Object.entries(n).forEach(([e,n])=>{let r=t$1.querySelector(`[data-setting="${e}"]`);r&&(r.value=n);}),r.textContent=`✓ Imported ${Object.keys(n).length}`,setTimeout(()=>{r.textContent=`Import`;},1500);})));}var xn=`mainNavigation`,Sn=`
...
`;function Cn(e,t){return wn.apply(this,arguments)}function wn(){return wn=t(function*(e,t){let n=`/autocomplete/${e}?term=${encodeURIComponent(t)}`,r=yield fetch(n,{headers:{Accept:`application/json`}});if(!r.ok)throw Error(`HTTP ${r.status}`);let i=yield r.json();return Array.isArray(i)?i:[]}),wn.apply(this,arguments)}function Tn(e){let t=e.replace(/\*/g,`*x*`).replace(/\//g,`*s*`).replace(/&/g,`*a*`).replace(/\./g,`*d*`).replace(/\?/g,`*q*`).replace(/#/g,`*h*`);return `/tags/${encodeURIComponent(t)}/works`}function En(e,t,n){for(let r=1;r<=5;r+=1){let i=e.querySelector(`[data-setting="quickLink${r}Label"]`),a=e.querySelector(`[data-setting="quickLink${r}Url"]`);if(!i||!a)return  false;if(!i.value&&!a.value)return i.value=t,a.value=n,a.dispatchEvent(new Event(`change`,{bubbles:true})),true}return  false}function Dn(t$1){let n=t$1.querySelector(`[data-action="search-tag"]`),r=t$1.querySelector(`#ao3h-mn-ac-term`),i=t$1.querySelector(`#ao3h-mn-ac-type`),a=t$1.querySelector(`#ao3h-mn-ac-results`);if(!n||!r||!i||!a||n.dataset.wired)return;n.dataset.wired=`1`;function o(){return s.apply(this,arguments)}function s(){return s=t(function*(){let e=r.value.trim();if(!e)return;a.textContent=`Searching…`;let n;try{n=yield Cn(i.value,e);}catch(e){a.textContent=`Search failed — are you on an AO3 page?`;return}if(a.textContent=``,!n.length){a.textContent=`No matching tag found.`;return}n.slice(0,8).forEach(e=>{let n=document.createElement(`li`),r=document.createElement(`button`);r.className=`ao3h-config-action-btn ao3h-inline-btn`,r.textContent=`+ ${e.name}`,r.title=`Add as quick link`,r.addEventListener(`click`,()=>{let n=En(t$1,e.name,Tn(e.name));r.textContent=n?`✓ Added`:`All 5 slots full`,r.disabled=true;}),n.appendChild(r),a.appendChild(n);});}),s.apply(this,arguments)}n.addEventListener(`click`,o),r.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),o());});}var On=`seriesHelper`,kn=`
...
`;function Rn(e){let t=e.querySelector(`[data-action="export-search-history"]`);t&&!t.dataset.wired&&(t.dataset.wired=`1`,t.addEventListener(`click`,()=>{n(st$1(`ao3h:se:history`,[]),`ao3h-search-history.json`);}));}var zn=`similarFics`,Bn=`
...
`,Vn=`ao3h:surpriseMe:history`;function Hn(){try{let e=JSON.parse(localStorage.getItem(Vn)||`[]`);return Array.isArray(e)?e:[]}catch(e){return []}}function Un(){try{localStorage.setItem(Vn,`[]`);}catch(e){}}var Wn=`surpriseMe`,Gn=`
...
`;function Kn(e$1){let t=e$1.querySelector(`#ao3h-sm-history`);if(!t)return;let n=Hn();if(!n.length){t.innerHTML=`<p class="ao3h-sm-history-empty">No draws yet.</p>`;return}t.innerHTML=`<ul class="ao3h-sm-history-list">${n.slice(0,20).map(e$1=>`
    <li>
  ...
  `).join(``)}</ul>`;}function qn(e){Kn(e);let t=e.querySelector(`[data-action="clear-history"]`);t==null||t.addEventListener(`click`,()=>{Un(),Kn(e);});}var Jn=`tropeGames`,Yn=`
...
`;function er(e){let t=e.querySelector(`#ao3h-bv-statusFilter`),n=e.querySelector(`#ao3h-bv-statusFilter-opts`);!t||!n||t.dataset.wired||(t.dataset.wired=`1`,n.style.display=t.checked?``:`none`,t.addEventListener(`change`,()=>{n.style.display=t.checked?``:`none`;}));}var tr=`fanficBingeMode`,nr=`
...
`,cr=`ao3h:laterShelf:items`,lr=`ao3h:laterShelf:archive`,ur=`ao3h:laterShelf:reminders`,dr=`ao3h:laterShelf:reminders:history`,fr=`ao3h:rt:history`,pr=`ao3h:ficAppreciation:status`;function mr(e,t){try{let n=JSON.parse(localStorage.getItem(e)||`null`);return n==null?t:n}catch(e){return t}}function hr(e,t){try{localStorage.setItem(e,JSON.stringify(t));}catch(e){}}function X(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function gr(){let e=mr(cr,[]);return Array.isArray(e)?e:[]}function _r(e){hr(cr,e);}function vr(){let e=mr(lr,[]);return Array.isArray(e)?e:[]}function yr(e){hr(lr,e);}function br(){let e=mr(ur,{});return e&&typeof e==`object`?e:{}}function xr(){let e=mr(dr,[]);return Array.isArray(e)?e:[]}function Sr(){let e=mr(fr,[]);return Array.isArray(e)?e:[]}function Cr(){let e=mr(pr,{});return e&&typeof e==`object`?e:{}}function wr(e){let t=gr(),n={};t.forEach(e=>{e.group&&(n[e.group]=(n[e.group]||0)+1);});let r=Object.keys(n).sort();if(!r.length){e.innerHTML=`<p class="ao3h-ls-cfg-empty">No groups yet — assign one from the MFL page.</p>`;return}e.innerHTML=r.map(e=>`
    ...
    </div>`).join(``);}function Tr(e){e.addEventListener(`click`,t=>{let n=t.target.closest(`[data-action="ls-rename-group"]`),i=t.target.closest(`[data-action="ls-clear-group"]`);if(n){let t=n.dataset.group,i=window.prompt(`Rename group "${t}" to:`,t);if(i===null||!i.trim()||i.trim()===t)return;_r(gr().map(e=>e.group===t?d$1(d$1({},e),{},{group:i.trim()}):e)),wr(e);}else if(i){let t=i.dataset.group;if(!window.confirm(`Remove the "${t}" group from all its fics? (the fics themselves stay on the shelf)`))return;_r(gr().map(e=>e.group===t?d$1(d$1({},e),{},{group:``}):e)),wr(e);}});}function Er(e){let t=vr();if(!t.length){e.innerHTML=`<p class="ao3h-ls-cfg-empty">No removed fics yet.</p>`;return}e.innerHTML=t.slice(0,50).map(e=>`
    ...
    </div>`).join(``);}function Dr(e){e.addEventListener(`click`,t=>{var i;let a=t.target.closest(`[data-action="ls-restore"]`),o=t.target.closest(`[data-action="ls-forget"]`),s=(i=a||o)==null?void 0:i.dataset.wid;if(!s)return;let c=vr(),l=c.findIndex(e=>String(e.wid)===String(s));if(l===-1)return;let[u]=c.splice(l,1);if(yr(c),a){let{removedAt:e}=u,t=t$1(u,ar),i=gr();i.some(e=>String(e.wid)===String(s))||(i.push(d$1(d$1({},t),{},{addedAt:Date.now(),order:Date.now()})),_r(i),document.dispatchEvent(new CustomEvent(ae$1,{detail:{workId:t.wid,title:t.title}})));}Er(e);});}var Or={fired:`🔔 Fired`,cancelled:`✕ Cancelled`,snoozed:`💤 Snoozed`};function kr(e){let t=xr();if(!t.length){e.innerHTML=`<p class="ao3h-ls-cfg-empty">No reminder activity yet.</p>`;return}e.innerHTML=t.slice(0,50).map(e=>`
    <div class="ao3h-ls-cfg-row">
      <span>${Or[e.action]||e.action}</span>
      <a href="https://archiveofourown.org/works/${X(e.wid)}" target="_blank" rel="noopener">${X(e.title||`Work ${e.wid}`)}</a>
      ${e.special?`<span class="ao3h-ls-cfg-meta">(${X(e.special)})</span>`:``}
      <span class="ao3h-ls-cfg-meta">${e.at?new Date(e.at).toLocaleString():``}</span>
    </div>`).join(``);}function Ar(e){let t=new Set(gr().map(e=>String(e.wid))),n=br(),r=Sr().filter(e=>e.totalChapters&&e.chapter&&e.chapter<e.totalChapters&&!t.has(String(e.id)));if(!r.length){e.innerHTML=`<p class="ao3h-ls-cfg-empty">Nothing in progress outside your shelf right now.</p>`;return}e.innerHTML=r.slice(0,20).map(e=>`
    ...
    </div>`).join(``);}function jr(e){e.addEventListener(`click`,t=>{let n=t.target.closest(`[data-action="ls-resume-remind"]`);if(!n)return;let r=n.closest(`.ao3h-ls-cfg-row`),i=r==null?void 0:r.dataset.wid,a=(r==null?void 0:r.dataset.title)||`Work ${i}`;if(!i)return;let o=window.prompt(`Remind me to resume "${a}" on (YYYY-MM-DD):`);if(!o||!o.trim())return;let s=Date.parse(o.trim());if(isNaN(s)){window.alert(`Invalid date. Please use YYYY-MM-DD format.`);return}let c=br();c[i]={title:a,remindAt:s,status:`pending`},hr(ur,c),Ar(e);});}function Mr(e){let t=gr(),n=t.length,r=new Set(Sr().map(e=>String(e.id))),i=Cr(),a=new Set(Object.keys(i).filter(e=>{var t;return ((t=i[e])==null?void 0:t.status)===`dropped`})),o=t.filter(e=>r.has(String(e.wid))).length,s=t.filter(e=>a.has(String(e.wid))).length,c=n?Math.round(o/n*100):0;e.innerHTML=`
  ...
  `;}function Nr(e){let t=e.querySelector(`#ao3h-ls-cfg-groups-list`);t&&!t.dataset.wired&&(t.dataset.wired=`1`,Tr(t),wr(t));let n=e.querySelector(`#ao3h-ls-cfg-archive-list`);n&&!n.dataset.wired&&(n.dataset.wired=`1`,Dr(n),Er(n));let r=e.querySelector(`#ao3h-ls-cfg-reminder-history`);r&&!r.dataset.wired&&(r.dataset.wired=`1`,kr(r));let i=e.querySelector(`#ao3h-ls-cfg-resume-list`);i&&!i.dataset.wired&&(i.dataset.wired=`1`,jr(i),Ar(i));let a=e.querySelector(`#ao3h-ls-cfg-stats`);a&&!a.dataset.wired&&(a.dataset.wired=`1`,Mr(a));}document.addEventListener(`ao3h:configOpen`,function(e){var t;((t=e.detail)==null?void 0:t.moduleId)===`laterShelf`&&Nr(e.target);});var Pr=`notificationCenter`,Fr=`
...
`,Br=e=>!!e&&typeof e==`object`&&!Array.isArray(e)&&Object.values(e).every(e=>typeof e==`string`),Vr=e=>Array.isArray(e)&&e.length>0&&e.every(e=>Number.isInteger(e)&&e>=0&&e<=255);function Hr(e){return (e==null?void 0:e.type)||`standard`}function Ur(e){if(!e||typeof e!=`object`)return {valid:false,type:`unknown`,reason:`not an object`};let t=Hr(e);if(!e.timestamp||Number.isNaN(new Date(e.timestamp).getTime()))return {valid:false,type:t,reason:`invalid timestamp`};switch(t){case `standard`:case `selective`:return Br(e.data)?{valid:true,type:t}:{valid:false,type:t,reason:`data is not a map of strings`};case `encrypted`:return Vr(e.salt)&&Vr(e.iv)&&Vr(e.ciphertext)?{valid:true,type:t}:{valid:false,type:t,reason:`missing or corrupt salt/iv/ciphertext`};case `compressed`:return Vr(e.compressed)?{valid:true,type:t}:{valid:false,type:t,reason:`missing or corrupt compressed bytes`};case `incremental`:return e.delta&&typeof e.delta==`object`&&!Array.isArray(e.delta)&&Object.values(e.delta).every(e=>e===null||typeof e==`string`)?{valid:true,type:t}:{valid:false,type:t,reason:`delta is not a map of strings/nulls`};default:return {valid:false,type:t,reason:`unknown type "${t}"`}}}function Wr(e){return Gr.apply(this,arguments)}function Gr(){return Gr=t(function*(e){let t=Ur(e);if(!t.valid||t.type!==`compressed`)return t;try{let n=yield Qr(e.compressed);return Br(JSON.parse(n))?t:{valid:!1,type:`compressed`,reason:`decompressed payload is not a map of strings`}}catch(e){return {valid:false,type:`compressed`,reason:`gunzip failed`}}}),Gr.apply(this,arguments)}function Kr(e){return {standard:`standard`,selective:`selective`,encrypted:`🔒 encrypted`,compressed:`📦 compressed`,incremental:`± incremental`}[e]||e}function qr(e){let t=Hr(e);return t===`standard`||t===`selective`?Object.keys(e.data||{}).length:t===`incremental`?Object.keys(e.delta||{}).length:null}function Jr(e,t){let n=(t||``).trim().toLowerCase();return !!(!n||new Date(e.timestamp).toLocaleString().toLowerCase().includes(n)||Object.keys(e.data||e.delta||{}).some(e=>e.toLowerCase().includes(n))||Array.isArray(e.categories)&&e.categories.some(e=>String(e).toLowerCase().includes(n)))}function Yr(e){return String(e||``).split(`,`).map(e=>e.trim()).filter(Boolean)}function Xr(e){return Zr.apply(this,arguments)}function Zr(){return Zr=t(function*(e){let t=[],n=e.getReader(),r,i;for(;{done:r,value:i}=yield n.read(),!r;)t.push(i);let a=new Uint8Array(t.reduce((e,t)=>e+t.length,0)),o=0;for(let e of t)a.set(e,o),o+=e.length;return a}),Zr.apply(this,arguments)}function Qr(e){return $r.apply(this,arguments)}function $r(){return $r=t(function*(e){let t=new DecompressionStream(`gzip`),n=t.writable.getWriter();return n.write(new Uint8Array(e)).catch(()=>{}),n.close().catch(()=>{}),new TextDecoder().decode(yield Xr(t.readable))}),$r.apply(this,arguments)}var ei=`backupAndSync`,ti=`
...
`,ni=`ao3h:backupAndSync:backups`;function ri(){var e;let t=(e=window.AO3H)==null?void 0:e.backupAndSync;if(t)return t.getBackups();try{let e=JSON.parse(localStorage.getItem(ni)||`[]`);return Array.isArray(e)?e:[]}catch(e){return []}}function ii(e){try{localStorage.setItem(ni,JSON.stringify(e));}catch(e){}}function ai(){return oi.apply(this,arguments)}function oi(){return oi=t(function*({mode:e=`standard`,categories:t=[]}={}){var n;let r=(n=window.AO3H)==null?void 0:n.backupAndSync;if(!r)return alert(`Enable the Backup & Sync module to create backups.`),null;if(e===`encrypted`){let e=prompt(`Password for this encrypted backup:`);return e?r.createEncryptedBackup(e):null}return e===`compressed`?r.createCompressedBackup():e===`incremental`?r.createIncrementalBackup():t.length?r.createSelectiveBackup(t):r.createBackup()}),oi.apply(this,arguments)}function si(e,t){let n=new Blob([JSON.stringify(e,null,2)],{type:`application/json`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=t,i.click(),URL.revokeObjectURL(r);}function ci(e){return e<1024?`${e} B`:`${(e/1024).toFixed(1)} KB`}function li(t$1){let n=t$1.querySelector(`#ao3h-bas-list`),r=t$1.querySelector(`#ao3h-bas-search`);if(!n)return;function i(){var e;let n=parseInt((e=t$1.querySelector(`[data-setting="maxBackups"]`))==null?void 0:e.value,10);return Number.isFinite(n)&&n>0?n:10}function a(){let t$1=ri(),i=((r==null?void 0:r.value)||``).trim(),o=t$1.map((e,t)=>({b:e,idx:t})).filter(({b:e})=>Jr(e,i));if(n.innerHTML=``,!t$1.length){let e=document.createElement(`div`);e.className=`ao3h-bas-empty`,e.textContent=`No backups yet — click "Backup Now" to create one.`,n.appendChild(e);return}if(!o.length){let e=document.createElement(`div`);e.className=`ao3h-bas-empty`,e.textContent=`No backups match your search.`,n.appendChild(e);return}o.forEach(({b:t$1,idx:r})=>{let i=document.createElement(`div`);i.className=`ao3h-bas-row`;let o=Ur(t$1),s=document.createElement(`span`);s.className=`ao3h-bas-row-status`;let c=e=>{s.textContent=e.valid?`✓`:`⚠️`,s.classList.toggle(`ao3h-bas-row-status--bad`,!e.valid),s.title=e.valid?`Backup is valid and restorable`:`Corrupt backup: ${e.reason}`;};c(o),o.valid&&o.type===`compressed`&&Wr(t$1).then(e=>{s.isConnected&&c(e);});let l=document.createElement(`div`);l.className=`ao3h-bas-row-info`;let u=new Blob([JSON.stringify(t$1)]).size,d=qr(t$1),f=[Kr(o.type)];d!==null&&f.push(`${d} keys`),f.push(ci(u)),l.textContent=`${new Date(t$1.timestamp).toLocaleString()} — ${f.join(`, `)}`;let p=document.createElement(`div`);p.className=`ao3h-bas-row-actions`;let m=document.createElement(`button`);m.type=`button`,m.className=`ao3h-config-action-btn ao3h-inline-btn`,m.textContent=`Restore`,m.addEventListener(`click`,t(function*(){var e;let n=new Date(t$1.timestamp).toLocaleString();if(!Ur(t$1).valid){alert(`This backup is corrupt (${Ur(t$1).reason}) and cannot be restored.`);return}let i=(e=window.AO3H)==null?void 0:e.backupAndSync;if(!i){alert(`Enable the Backup & Sync module to restore backups.`);return}let a=Hr(t$1),o;if(a===`incremental`)o=yield i.restoreIncrementalBackup(r);else if(a===`encrypted`){let e=prompt(`Password for the encrypted backup from ${n}:`);if(!e)return;if(o=yield i.restoreEncryptedBackup(r,e),!o){alert(`Decryption failed — wrong password or corrupt backup.`);return}}else if(a===`compressed`){if(o=yield i.restoreCompressedBackup(r),!o){alert(`This compressed backup could not be read.`);return}}else o=i.restoreBackup(r);o&&(m.textContent=`✓ Restored`,setTimeout(()=>{m.textContent=`Restore`;},1500));}));let h=document.createElement(`button`);h.type=`button`,h.className=`ao3h-config-action-btn ao3h-inline-btn ao3h-inline-btn--danger`,h.textContent=`🗑️`,h.title=`Delete this backup`,h.addEventListener(`click`,()=>{let e=ri();e.splice(r,1),ii(e),a();}),p.append(m,h),i.append(s,l,p),n.appendChild(i);});}if(r&&!r.dataset.wired){r.dataset.wired=`1`;let e=0;r.addEventListener(`input`,()=>{clearTimeout(e),e=setTimeout(a,150);});}let o=t$1.querySelector(`[data-action="backup-now"]`);o&&!o.dataset.wired&&(o.dataset.wired=`1`,o.addEventListener(`click`,t(function*(){var e,n;(yield ai({mode:((e=t$1.querySelector(`#ao3h-bas-mode`))==null?void 0:e.value)||`standard`,categories:Yr((n=t$1.querySelector(`#ao3h-bas-categories`))==null?void 0:n.value)}))&&(a(),o.textContent=`✓ Backed Up`,setTimeout(()=>{o.textContent=`☁️ Backup Now`;},1500));})));let s=t$1.querySelector(`[data-action="export-backup"]`);s&&!s.dataset.wired&&(s.dataset.wired=`1`,s.addEventListener(`click`,()=>{let e=ri();if(!e.length){alert(`No backups to export yet.`);return}si(e,`ao3h-backups-${new Date().toISOString().replace(/[:.]/g,`-`)}.json`);}));let c=t$1.querySelector(`[data-action="import-backup"]`);c&&!c.dataset.wired&&(c.dataset.wired=`1`,c.addEventListener(`click`,()=>{let e=document.createElement(`input`);e.type=`file`,e.accept=`.json,application/json`,e.addEventListener(`change`,()=>{var t;let n=(t=e.files)==null?void 0:t[0];if(!n)return;let r=new FileReader;r.onload=()=>{try{let e=JSON.parse(String(r.result));if(!Array.isArray(e))throw Error(`Expected an array of backups.`);let t=e.filter(e=>Ur(e).valid);if(!t.length)throw Error(`No valid backups found in file.`);let n=ri(),o=n.concat(t).sort((e,t)=>new Date(t.timestamp).getTime()-new Date(e.timestamp).getTime()).slice(0,i());n.length=0,n.push(...o),ii(n),a(),c.textContent=`✓ Imported ${t.length}`,setTimeout(()=>{c.textContent=`Import`;},1500);}catch(e){alert(`Import failed: `+((e==null?void 0:e.message)||`invalid file`));}},r.readAsText(n);}),e.click();}));let l=t$1.querySelector(`[data-action="clear-all-backups"]`);l&&!l.dataset.wired&&(l.dataset.wired=`1`,l.addEventListener(`click`,()=>{let e=ri();e.length&&confirm(`Delete all backups? This cannot be undone.`)&&(e.length=0,ii(e),a());})),a();}var ui=`ao3h:OfflineReading:library`,di=4*1024*1024;function fi(e=localStorage){var t;let n=(t=window.AO3H)==null?void 0:t.ficDownloader;if(n!=null&&n.getOfflineWorks)return n.getOfflineWorks();try{let t=JSON.parse(e.getItem(`ao3h:OfflineReading:library`)||`{}`);return t&&typeof t==`object`&&!Array.isArray(t)?t:{}}catch(e){return {}}}function pi(e){return !Number.isFinite(e)||e<0?`0 B`:e<1024?`${Math.round(e)} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:`${(e/(1024*1024)).toFixed(1)} MB`}function mi(e){try{return JSON.stringify(e||{}).length*2}catch(e){return 0}}function hi(e){return Object.entries(e||{}).map(([e,t])=>{let n=mi(t);return {workId:e,title:(t==null?void 0:t.title)||`Work ${e}`,author:(t==null?void 0:t.author)||`Anonymous`,date:(t==null?void 0:t.date)||0,dateLabel:t!=null&&t.date?new Date(t.date).toLocaleString():`—`,sizeLabel:pi(n),bytes:n}}).sort((e,t)=>t.date-e.date)}function gi(e,t=di){let n=0,r=Object.values(e||{});for(let e of r)n+=mi(e);return {count:r.length,bytes:n,label:`${r.length} work${r.length===1?``:`s`} — ${pi(n)}`,warn:n>=t}}function _i(e,t=localStorage){var n;let r=(n=window.AO3H)==null?void 0:n.ficDownloader;if(r!=null&&r.removeOffline)return r.removeOffline(e),r.getOfflineWorks();let i=fi(t);delete i[e];try{t.setItem(ui,JSON.stringify(i));}catch(e){}return i}function vi(e=localStorage){try{e.setItem(ui,`{}`);}catch(e){}return {}}var yi=`ficDownloader`,bi=`
...
`;function xi(e,t,n){let r=e.querySelector(t),i=e.querySelector(n);!r||!i||r.dataset.wired||(r.dataset.wired=`1`,i.style.display=r.checked?``:`none`,r.addEventListener(`change`,()=>{i.style.display=r.checked?``:`none`;}));}function Si(e){if(!(e!=null&&e.html)||typeof URL.createObjectURL!=`function`)return;let t=new Blob([e.html],{type:`text/html;charset=utf-8`}),n=URL.createObjectURL(t);window.open(n,`_blank`)?setTimeout(()=>URL.revokeObjectURL(n),1e4):URL.revokeObjectURL(n);}function Ci(e){let t=e.querySelector(`#ao3h-dl-offline-list`),n=e.querySelector(`#ao3h-dl-offline-total`),r=e.querySelector(`#ao3h-dl-offline-search`);if(!t)return;function i(){let e=fi(),a=((r==null?void 0:r.value)||``).trim().toLowerCase(),o=hi(e).filter(e=>!a||e.title.toLowerCase().includes(a)||e.author.toLowerCase().includes(a)),s=gi(e);if(n&&(n.textContent=s.count?`${s.label}${s.warn?` — ⚠️ close to the browser storage limit`:``}`:``,n.classList.toggle(`ao3h-dl-offline-total--warn`,s.warn)),t.innerHTML=``,!o.length){let e=document.createElement(`div`);e.className=`ao3h-dl-offline-empty`,e.textContent=s.count?`No offline works match your search.`:`No works saved offline yet — use "📥 Save Offline" on a work page.`,t.appendChild(e);return}o.forEach(e=>{let n=document.createElement(`div`);n.className=`ao3h-dl-offline-row`;let r=document.createElement(`div`);r.className=`ao3h-dl-offline-row-info`,r.textContent=`${e.title} — ${e.author} (${e.dateLabel}, ${e.sizeLabel})`,r.title=`Work ${e.workId}`;let a=document.createElement(`div`);a.className=`ao3h-dl-offline-row-actions`;let o=document.createElement(`button`);o.type=`button`,o.className=`ao3h-config-action-btn ao3h-inline-btn`,o.textContent=`📖 Read`,o.title=`Open the cached copy in a new tab`,o.addEventListener(`click`,()=>{Si(fi()[e.workId]);});let s=document.createElement(`button`);s.type=`button`,s.className=`ao3h-config-action-btn ao3h-inline-btn ao3h-inline-btn--danger`,s.textContent=`🗑️`,s.title=`Remove from offline library`,s.addEventListener(`click`,()=>{_i(e.workId),i();}),a.append(o,s),n.append(r,a),t.appendChild(n);});}if(r&&!r.dataset.wired){r.dataset.wired=`1`;let e=0;r.addEventListener(`input`,()=>{clearTimeout(e),e=setTimeout(i,150);});}let a=e.querySelector(`[data-action="clear-offline-library"]`);a&&!a.dataset.wired&&(a.dataset.wired=`1`,a.addEventListener(`click`,()=>{gi(fi()).count&&confirm(`Remove all works saved offline? This cannot be undone.`)&&(vi(),i());})),i();}function wi(e){xi(e,`#ao3h-dl-kindle`,`#ao3h-dl-kindle-opts`),xi(e,`#ao3h-dl-calibre`,`#ao3h-dl-calibre-opts`),Ci(e);}var Ti=`themeBuilder`,Ei=`
...
`},Ai={[ki.moduleId]:ki.config,[D]:O,[k]:ae,[L]:fe,[Ue]:We,[Ke]:qe,[yt]:bt,[Pt]:Ft,[It]:Lt,[Rt]:zt,[Bt]:Vt,[Ht]:Ut,[Wt]:Gt,[ln]:un,[dn]:fn,[pn]:mn,[hn]:gn,[_n]:yn,[xn]:Sn,[On]:kn,[An]:jn,[Mn]:Nn,[Pn]:Fn,[In]:Ln,[zn]:Bn,[Wn]:Gn,[Jn]:Yn,[Xn]:Zn,[Qn]:$n,[tr]:nr,[rr]:ir,[or]:sr,[Pr]:Fr,[Ir]:Lr,[Rr]:zr,[ei]:ti,[yi]:bi,[Ti]:Ei,[Di]:Oi};function ji(e){return Ai[e]||Ai._default}function Mi(){return Object.keys(Ai).filter(e=>e!==`_default`&&typeof Ai[e]==`string`)}var Z={};typeof I==`function`&&(Z[k]=I),typeof He==`function`&&(Z[L]=He),typeof li==`function`&&(Z[ei]=li),typeof wi==`function`&&(Z[yi]=wi),typeof er==`function`&&(Z[Qn]=er),typeof qn==`function`&&(Z[Wn]=qn),typeof bn==`function`&&(Z[_n]=bn),typeof Dn==`function`&&(Z[xn]=Dn),typeof Rn==`function`&&(Z[In]=Rn),typeof cn==`function`&&(Z[Wt]=cn),typeof Nr==`function`&&(Z[or]=Nr);function Ni(e,t){let n=Z[e];typeof n==`function`&&n(t);}console.log(`[AO3H][panel-configs] Panel configs index loaded - `+Mi().length+` modules registered`);var Pi=typeof unsafeWindow<`u`?unsafeWindow:window,Q={pendingSaves:0,dirty:false,_savedTimer:null},Fi=new Set((ht$1||[]).map(e=>e.id));function Ii(){return (ht$1==null?void 0:ht$1.length)||0}function Li(){var e,t,n,r,i,a;let o=((e=window.AO3H)==null?void 0:e.flags)||((t=Pi.AO3H)==null?void 0:t.flags),s=(((n=window.AO3H)==null||(n=n.modules)==null||(r=n.all)==null?void 0:r.call(n))||((i=Pi.AO3H)==null||(i=i.modules)==null||(a=i.all)==null?void 0:a.call(i))||[]).filter(e=>Fi.has(e==null?void 0:e.name));return !o||typeof o.get!=`function`||!s.length?s.filter(e=>e==null?void 0:e._booted).length:s.reduce((e,t)=>{var n;let r=(t==null?void 0:t.enabledKey)||`mod:${t==null?void 0:t.name}:enabled`,i=!!(!(t==null||(n=t.meta)==null)&&n.enabledByDefault);return e+ +!!o.get(r,i)},0)}function $(){let e=document.getElementById(`ao3h-panel-footer-status`);e&&(e.innerHTML=`<strong>${Li()}</strong> enabled · ${Ii()} modules total · ${Q.dirty?`<span class="ao3h-footer-unsaved">Unsaved changes</span>`:`All changes saved`}`);}function Ri(){Q.pendingSaves+=1,Q.dirty=true,clearTimeout(Q._savedTimer),$();}function zi(e){if(Q.pendingSaves>0&&--Q.pendingSaves,e===false){Q.dirty=true,$();return}clearTimeout(Q._savedTimer),Q._savedTimer=setTimeout(()=>{Q.pendingSaves===0&&(Q.dirty=false),$();},1500);}function Bi(){document.querySelectorAll(`[data-config-module]`).forEach(e=>{let t=e.dataset.configModule,n=ji(t);(e.innerHTML=n,Ni(t,e));});}function Vi(e,t){e.addEventListener(`click`,T),t.querySelectorAll(`.${C}-panel-close, .ao3h-footer-close`).forEach(e=>{e.addEventListener(`click`,T);});let n=function(e){e.key===`Escape`&&(T(),document.removeEventListener(`keydown`,n));};document.addEventListener(`keydown`,n),console.log(`[AO3H][tab-system] ✅ Close handlers attached`);}function Hi(e,t){var n;let r=e.closest(`.${C}-panel-body`),i=r==null||(n=r.parentElement)==null?void 0:n.querySelector(`.${C}-bulk-actions`);i&&i.remove();let a=document.createElement(`div`);a.className=`${C}-bulk-actions`,a.innerHTML=`
    ...
    `,r!=null&&r.parentElement&&(r.parentElement.appendChild(a),a.querySelector(`.ao3h-footer-save-close`).addEventListener(`click`,qi)),$();let o=r==null?void 0:r.closest(`.${C}-panel-box`);o==null||o.querySelectorAll(`.ao3h-bulk-actions-buttons .ao3h-panel-action-btn[data-action]`).forEach(t=>{let n=t.cloneNode(true);t.replaceWith(n),n.addEventListener(`click`,function(){let t=this.getAttribute(`data-action`),n=e.querySelectorAll(`.ao3h-quick-enable-checkbox`),r=t===`enable-all`;n.forEach(e=>{e.checked=r,e.dispatchEvent(new Event(`change`,{bubbles:true}));}),console.log(`[AO3H][tab-system] ${t}: ${n.length} modules`);});}),console.log(`[AO3H][tab-system] ✅ Bulk actions setup for tab:`,t);}function Ui(e){e.querySelectorAll(`.ao3h-picker-row`).forEach(e=>{let t=e.querySelector(`.ao3h-picker`),n=e.querySelector(`[data-action^="add"]`),r=e.parentElement.querySelector(`.ao3h-chip-container`);if(!t||!n||!r)return;let i=t.dataset.pickerType||`item`,a=[];try{let e=r.dataset.value;e&&(a=JSON.parse(e));}catch(e){}function o(){r.innerHTML=``,a.forEach(e=>{let n=t.querySelector(`option[value="${e}"]`);c(e,n?n.textContent:e,false);}),s();}function s(){r.dataset.value=JSON.stringify(a),r.dispatchEvent(new CustomEvent(`chipsChanged`,{detail:{type:i,items:a},bubbles:true}));}function c(e,t,n=true){n&&!a.includes(e)&&a.push(e);let o=document.createElement(`span`);o.className=`ao3h-chip`,o.dataset.value=e,o.innerHTML=`${t} <button type="button" title="Remove ${t}" aria-label="Remove ${t}">×</button>`,o.querySelector(`button`).addEventListener(`click`,()=>{o.remove(),a=a.filter(t=>t!==e),s(),console.log(`[AO3H][chip-picker:${i}] Removed:`,e);}),r.appendChild(o);}function l(){var e;let n=t.value;if(!n)return;let r=(e=t.options[t.selectedIndex])==null?void 0:e.text;if(a.includes(n)){console.log(`[AO3H][chip-picker:${i}] Already added:`,n);return}c(n,r,true),s(),t.selectedIndex=0,console.log(`[AO3H][chip-picker:${i}] Added:`,n,`| Total:`,a.length);}n.addEventListener(`click`,l),t.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),l());}),o(),console.log(`[AO3H][tab-system] ✅ Chip picker setup (${i})`);});}function Wi(e){e.querySelectorAll(`.ao3h-config-reset-btn`).forEach(e=>{let t=null,n=e.textContent.trim(),r=e.dataset.fullReset===`true`;e.addEventListener(`click`,function(){if(this.classList.contains(`ao3h-reset-confirming`))if(clearTimeout(t),this.classList.remove(`ao3h-reset-confirming`),this.textContent=n,r){try{Object.keys(localStorage).filter(e=>e.startsWith(`ao3h`)).forEach(e=>localStorage.removeItem(e));}catch(e){}location.reload();}else {let e=this.closest(`.ao3h-module-config-area`);e&&e.querySelectorAll(`input, select, textarea`).forEach(e=>{e.type===`checkbox`||e.type===`radio`?e.checked=e.defaultChecked:e.tagName===`SELECT`?Array.from(e.options).forEach(e=>{e.selected=e.defaultSelected;}):e.value=e.defaultValue,e.dispatchEvent(new Event(`change`,{bubbles:true}));}),console.log(`[AO3H][tab-system] Module reset confirmed`);}else this.classList.add(`ao3h-reset-confirming`),this.textContent=r?`⚠ Reset everything?`:`⚠ Confirm reset?`,t=setTimeout(()=>{this.classList.remove(`ao3h-reset-confirming`),this.textContent=n;},3e3);});});}function Gi(e){return Ki.apply(this,arguments)}function Ki(){return Ki=t(function*(e){var t,n;let r=e.dataset.configModule;if(!r)return;let i=e.querySelectorAll(`[data-setting]`),a={},s=new Set;i.forEach(t=>{let n=t.dataset.setting;if(n)if(t.type===`checkbox`)a[n]=t.checked;else if(t.type===`radio`){if(!s.has(n)){s.add(n);let t=e.querySelector(`input[type="radio"][data-setting="${n}"]:checked`);t&&(a[n]=t.value);}}else a[n]=t.value;});let c=((t=window.AO3H)==null?void 0:t.settings)||((n=Pi.AO3H)==null?void 0:n.settings);if(c)yield c.set(r,a);else {let e=`ao3h:mod:${r}:settings`,t=JSON.parse(localStorage.getItem(e)||`{}`);localStorage.setItem(e,JSON.stringify(Object.assign({},t,a)));}document.dispatchEvent(new CustomEvent(b,{bubbles:false,detail:{moduleId:r,settings:a}}));}),Ki.apply(this,arguments)}function qi(){return Ji.apply(this,arguments)}function Ji(){return Ji=t(function*(){let e=document.querySelectorAll(`.ao3h-module-config-area`);for(let t of e)try{yield Gi(t);}catch(e){console.error(`[AO3H][tab-system] Save failed for`,t.dataset.configModule,e);}Q.dirty=false,Q.pendingSaves=0,T();}),Ji.apply(this,arguments)}function Yi(e){e.querySelectorAll(`[data-config-module]`).forEach(e=>{let t=e.dataset.configModule;if(t)try{let n=localStorage.getItem(`ao3h:mod:${t}:settings`);if(!n)return;let r=JSON.parse(n);e.querySelectorAll(`[data-setting]`).forEach(e=>{let t=e.dataset.setting;t in r&&(e.type===`checkbox`?e.checked=!!r[t]:e.type===`radio`?e.checked=e.value===r[t]:e.value=r[t]);});}catch(e){}});}function Xi(e){e.querySelectorAll(`.ao3h-module-config-area`).forEach(e=>{e.dataset.autoSaveWired||(e.dataset.autoSaveWired=`1`,e.addEventListener(`change`,e=>{e.target.closest(`[data-setting]`)&&(Q.dirty=true,clearTimeout(Q._savedTimer),$());}));});}function Zi(t$1){t$1.querySelectorAll(`.ao3h-config-save-btn`).forEach(t$1=>{t$1.addEventListener(`click`,t(function*(){let e=this.closest(`.ao3h-module-config-area`);if(!e||!e.dataset.configModule)return;Ri();try{yield Gi(e),zi(!0);}catch(t){zi(false),console.error(`[AO3H][tab-system] Save failed for`,e.dataset.configModule,t);return}let t=this.textContent;this.textContent=`✓ Saved`,this.classList.add(`ao3h-save-success`),setTimeout(()=>{this.textContent=t,this.classList.remove(`ao3h-save-success`);},1500);}));});}function Qi(e){e.querySelectorAll(`.ao3h-config-btn`).forEach(e=>{e.setAttribute(`aria-label`,`Module settings`),e.setAttribute(`aria-expanded`,`false`),e.addEventListener(`click`,function(e){e.stopPropagation();let t=this.closest(`.ao3h-module-container`),n=t.querySelector(`.ao3h-module-config-area`);if(n){let e=n.classList.contains(`ao3h-expanded`);if(n.classList.toggle(`ao3h-expanded`),this.textContent=e?`▼`:`▲`,this.setAttribute(`aria-expanded`,e?`false`:`true`),!e){let e=t.dataset.moduleId;Ni(e,n),n.dispatchEvent(new CustomEvent(`ao3h:configOpen`,{bubbles:true,detail:{moduleId:e,configArea:n}})),setTimeout(()=>{typeof window.AO3H_wireHelpButtons==`function`&&window.AO3H_wireHelpButtons(n);},0),setTimeout(()=>{let e=document.querySelector(`#ao3h-tab-container`);if(!e)return;let n=t.getBoundingClientRect(),r=e.getBoundingClientRect(),i=n.top-r.top;Math.abs(i)>5&&e.scrollBy({top:i,behavior:`smooth`});},450);}console.log(`[AO3H][tab-system] Config toggled:`,e?`closed`:`opened`);}});});}function $i(t$1){t$1.querySelectorAll(`.ao3h-module-row`).forEach(t$1=>{let n=t$1.closest(`.ao3h-module-container`),r=n==null?void 0:n.dataset.moduleId,i=t$1.querySelector(`.ao3h-quick-enable-checkbox`);if(i&&r){var a,o,s,c,l,u,d;let n=((a=t$1.querySelector(`.ao3h-module-name`))==null||(a=a.textContent)==null?void 0:a.trim())||r;i.setAttribute(`aria-label`,`Enable ${n}`);let f=((o=window.AO3H)==null?void 0:o.flags)||((s=Pi.AO3H)==null?void 0:s.flags),p=(c=window.AO3H)==null?void 0:c.modules,m=p==null||(l=p.all)==null||(l=l.call(p))==null||(u=l.find)==null?void 0:u.call(l,e=>e.name===r),h=!!(!(m==null||(d=m.meta)==null)&&d.enabledByDefault);i.checked=f?!!f.get(`mod:${r}:enabled`,h):h,i.addEventListener(`change`,t(function*(){if(r){try{var e,t;let n=((e=Pi.AO3H)==null?void 0:e.modules)||((t=window.AO3H)==null?void 0:t.modules);n!=null&&n.setEnabled&&(yield n.setEnabled(r,this.checked)),$();}catch(e){console.error(`[AO3H][tab-system] setEnabled failed for`,r,e);}document.dispatchEvent(new CustomEvent(`ao3h:flags-updated`,{detail:{key:`mod:${r}:enabled`,value:this.checked}})),console.log(`[AO3H][tab-system]`,r,this.checked?`enabled`:`disabled`);}})),document.addEventListener(`ao3h:flags-updated`,function(e){var t;((t=e.detail)==null?void 0:t.key)===`mod:${r}:enabled`&&(i.checked=!!e.detail.value);});}t$1.addEventListener(`click`,function(e){if(e.target.closest(`.ao3h-module-quick-toggle`))return;let t=this.closest(`.ao3h-module-container`).querySelector(`.ao3h-config-btn`);t&&t.click();});});}function ea(e,t){console.log(`[AO3H][tab-system] 📥 Loading tab:`,e);let n=ie[e];if(!n){t.innerHTML=`<p style="color: #d32f2f;">❌ Unknown tab: ${e}</p>`;return}t.style.transition=`opacity 0.2s ease-out`,t.style.opacity=`0`,setTimeout(()=>{t.innerHTML=n,t.scrollTop=0,Bi(),Yi(t),setTimeout(()=>{t.style.opacity=`1`,Qi(t),Wi(t),Zi(t),Xi(t),$i(t),Ui(t);},20),setTimeout(()=>{if(e!==`about`)Hi(t,e);else {let e=document.querySelector(`.${C}-bulk-actions`);e&&e.remove();let n=t.closest(`.${C}-panel-body`);if(n!=null&&n.parentElement){let e=document.createElement(`div`);e.className=`${C}-bulk-actions`,e.innerHTML=`
              <div class="note-box ao3h-footer-status" id="ao3h-panel-footer-status" aria-live="polite"></div>
              <button class="ao3h-panel-action-btn ao3h-footer-close">Close</button>
            `,n.parentElement.appendChild(e),$();}ta(t);}},10);},200),typeof window.initializeTabInteractivity==`function`&&window.initializeTabInteractivity(),console.log(`[AO3H][tab-system] ✅ Tab content loaded:`,e);}function ta(e){var t,n;let r=e.querySelector(`#ao3h-pinned-module`),i=e.querySelector(`#ao3h-pin-save-btn`);if(!r||!i)return;let a=((t=window.AO3H)==null||(t=t.modules)==null||(n=t.all)==null?void 0:n.call(t))||[];for(let{name:e,meta:t}of a){let n=document.createElement(`option`);n.value=e,n.textContent=(t==null?void 0:t.title)||e,r.appendChild(n);}let o=localStorage.getItem(`ao3h:pinnedModule`);o&&r.querySelector(`option[value="${o}"]`)&&(r.value=o),i.addEventListener(`click`,()=>{let e=r.value;e?localStorage.setItem(`ao3h:pinnedModule`,e):localStorage.removeItem(`ao3h:pinnedModule`);let t=i.textContent;i.textContent=`✓ Saved`,setTimeout(()=>{i.textContent=t;},1500);});}function na(e){console.log(`[AO3H][tab-system] Setting up tab switching`);let t=e.querySelectorAll(`.${C}-tab-btn`),n=e.querySelector(`#${C}-tab-container`);t.forEach(e=>{e.addEventListener(`click`,function(){let e=this.getAttribute(`data-tab`);t.forEach(e=>{e.classList.remove(`${C}-tab-active`),e.setAttribute(`aria-selected`,`false`);}),this.classList.add(`${C}-tab-active`),this.setAttribute(`aria-selected`,`true`),n.setAttribute(`aria-labelledby`,`${C}-tab-btn-${e}`),ea(e,n),console.log(`[AO3H][tab-system] Switched to tab:`,e);});});let r=e.querySelector(`.ao3h-tab-btn.ao3h-tab-active`)||t[0],i=r?r.getAttribute(`data-tab`):`browse`;t.forEach(e=>e.setAttribute(`aria-selected`,e===r?`true`:`false`)),r&&n.setAttribute(`aria-labelledby`,`${C}-tab-btn-${i}`),console.log(`[AO3H][tab-system] Loading initial tab:`,i),ea(i,n);}function ra(e){let t=e.querySelector(`#${C}-tab-container`),n=e.querySelector(`#${C}-global-search`);if(!n||!t){console.warn(`[AO3H][global-search] Search input or tab container not found`);return}function r(){return ht$1||[]}let i=e.querySelector(`.ao3h-tab-btn.ao3h-tab-active`)||e.querySelector(`.ao3h-tab-btn`),a=i?i.getAttribute(`data-tab`):`browse`;e.querySelectorAll(`.${C}-tab-btn`).forEach(e=>{e.addEventListener(`click`,()=>{a=e.getAttribute(`data-tab`),n.value=``;});});let o;n.addEventListener(`input`,()=>{clearTimeout(o),o=setTimeout(()=>{let i=n.value.trim().toLowerCase(),o=r();if(!i){e.querySelectorAll(`.${C}-tab-btn`).forEach(e=>{e.classList.toggle(`${C}-tab-active`,e.getAttribute(`data-tab`)===a);}),ea(a,t);return}e.querySelectorAll(`.${C}-tab-btn`).forEach(e=>e.classList.remove(`${C}-tab-active`)),s(o.filter(e=>(e.title||``).toLowerCase().includes(i)||(e.desc||``).toLowerCase().includes(i)||(e.id||``).toLowerCase().includes(i)||(e.tabLabel||``).toLowerCase().includes(i)),i,t);},150);});function s(e,t,n){let r;r=e.length===0?`<p class="ao3h-search-no-results">No modules found for "<strong>${t}</strong>"</p>`:e.map(e=>`
