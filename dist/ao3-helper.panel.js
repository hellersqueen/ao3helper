...
<div class="ao3h-tab-content" data-tab="about">
    ...
    `}var ie=Object.fromEntries([...z$1.map(e=>[e.id,E(e)]),[`about`,re()]]);console.log(`[AO3H][panel-tab-content] Tab content generated - ${z$1.length} tabs + About, ${pt$1.length} modules`);var D=`ficEngagement`,O=`
...
`;function Rn(e){let t=e.querySelector(`[data-action="export-search-history"]`);t&&!t.dataset.wired&&(t.dataset.wired=`1`,t.addEventListener(`click`,()=>{n(at$1(`ao3h:se:history`,[]),`ao3h-search-history.json`);}));}var zn=`similarFics`,Bn=`
